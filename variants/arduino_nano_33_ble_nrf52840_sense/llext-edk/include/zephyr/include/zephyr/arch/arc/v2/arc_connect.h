...
#define ARC_CONNECT_CMD_DEBUG_MASK_SH			0x08
#define ARC_CONNECT_CMD_DEBUG_MASK_BH			0x04
#define ARC_CONNECT_CMD_DEBUG_MASK_AH			0x02
#define ARC_CONNECT_CMD_DEBUG_MASK_H			0x01
