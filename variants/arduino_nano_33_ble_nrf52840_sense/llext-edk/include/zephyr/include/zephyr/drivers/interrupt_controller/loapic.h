...
#define LOAPIC_ID 0x020
#define LOAPIC_VER 0x030
#define LOAPIC_TPR 0x080
#define LOAPIC_APR 0x090
#define LOAPIC_PPR 0x0a0
#define LOAPIC_EOI 0x0b0
#define LOAPIC_LDR 0x0d0
#define LOAPIC_DFR 0x0e0
#define LOAPIC_SVR 0x0f0
#define LOAPIC_ISR 0x100
#define LOAPIC_TMR 0x180
#define LOAPIC_IRR 0x200
#define LOAPIC_ESR 0x280
#define LOAPIC_ICRLO 0x300
#define LOAPIC_ICRHI 0x310
#define LOAPIC_TIMER 0x320
#define LOAPIC_THERMAL 0x330
#define LOAPIC_PMC 0x340
#define LOAPIC_LINT0 0x350
#define LOAPIC_LINT1 0x360
#define LOAPIC_ERROR 0x370
#define LOAPIC_TIMER_ICR 0x380
#define LOAPIC_TIMER_CCR 0x390
#define LOAPIC_TIMER_CONFIG 0x3e0
#define LOAPIC_SELF_IPI 0x3f0

#define LOAPIC_ICR_BUSY		0x00001000

#define LOAPIC_ICR_IPI_SPECIFIC 0x00004000U
#define LOAPIC_ICR_IPI_OTHERS	0x000C4000U
#define LOAPIC_ICR_IPI_INIT	0x00004500U
#define LOAPIC_ICR_IPI_STARTUP	0x00004600U

#define LOAPIC_LVT_MASKED 0x00010000

/* Defined in intc_loapic.c */
#define LOAPIC_REGS_STR				loapic_regs
