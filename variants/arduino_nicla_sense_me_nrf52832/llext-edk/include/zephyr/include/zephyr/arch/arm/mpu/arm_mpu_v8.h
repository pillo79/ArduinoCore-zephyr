...
#define R_NON_W_NON     0x0
#define R_NON_W_ALLOC   0x1
#define R_ALLOC_W_NON   0x2
#define R_ALLOC_W_ALLOC 0x3

/* Memory Attributes for Normal Memory */
#define NORMAL_O_WT_NT 0x80
#define NORMAL_O_WB_NT 0xC0
#define NORMAL_O_NON_C 0x40

#define NORMAL_I_WT_NT 0x08
#define NORMAL_I_WB_NT 0x0C
#define NORMAL_I_NON_C 0x04
