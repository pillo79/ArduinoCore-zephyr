...
#define AVRCP_CAT_1 BIT(0)
#define AVRCP_CAT_2 BIT(1)
#define AVRCP_CAT_3 BIT(2)
#define AVRCP_CAT_4 BIT(3)

#define AVRCP_SUBUNIT_PAGE           (0)
#define AVRCP_SUBUNIT_EXTENSION_COED (7)
