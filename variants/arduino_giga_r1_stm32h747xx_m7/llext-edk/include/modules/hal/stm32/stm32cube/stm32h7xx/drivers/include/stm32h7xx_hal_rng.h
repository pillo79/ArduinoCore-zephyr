...
typedef enum
{
  HAL_RNG_ERROR_CB_ID                   = 0x00U,

  HAL_RNG_MSPINIT_CB_ID                 = 0x01U,
  HAL_RNG_MSPDEINIT_CB_ID               = 0x02U
...
#define  HAL_RNG_ERROR_RECOVERSEED      0x00000020U
...
/**
  ...
  * @retval None
  */
#define __HAL_RNG_CLEAR_FLAG(__HANDLE__, __FLAG__)
