 ...
 */
typedef enum {
	NRF_USBD_COMMON_EPOUT0 = 0x00,
	NRF_USBD_COMMON_EPOUT1 = 0x01,
	NRF_USBD_COMMON_EPOUT2 = 0x02,
	NRF_USBD_COMMON_EPOUT3 = 0x03,
	NRF_USBD_COMMON_EPOUT4 = 0x04,
	NRF_USBD_COMMON_EPOUT5 = 0x05,
	NRF_USBD_COMMON_EPOUT6 = 0x06,
	NRF_USBD_COMMON_EPOUT7 = 0x07,
	NRF_USBD_COMMON_EPOUT8 = 0x08,

	NRF_USBD_COMMON_EPIN0 = 0x80,
	NRF_USBD_COMMON_EPIN1 = 0x81,
	NRF_USBD_COMMON_EPIN2 = 0x82,
	NRF_USBD_COMMON_EPIN3 = 0x83,
	NRF_USBD_COMMON_EPIN4 = 0x84,
	NRF_USBD_COMMON_EPIN5 = 0x85,
	NRF_USBD_COMMON_EPIN6 = 0x86,
	NRF_USBD_COMMON_EPIN7 = 0x87,
	NRF_USBD_COMMON_EPIN8 = 0x88,
...
typedef enum {
	...
	NRF_USBD_COMMON_EVT_RESET,
	NRF_USBD_COMMON_EVT_SUSPEND,
	NRF_USBD_COMMON_EVT_RESUME,
 ...
 */
typedef struct {
	nrf_usbd_common_event_type_t type;
	union {
		struct {
			uint16_t framecnt;
		} sof;
		struct {
			nrf_usbd_common_ep_t ep;
		} isocrc;
		struct {
			nrf_usbd_common_ep_t ep;
 ...
 */
typedef enum {
	NRF_USBD_COMMON_TRANSFER_ZLP_FLAG = 1U << 0,
