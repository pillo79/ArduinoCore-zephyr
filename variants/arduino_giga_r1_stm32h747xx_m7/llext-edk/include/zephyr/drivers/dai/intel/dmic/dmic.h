...
#define DMIC_UNMUTE_CIC		1
#define DMIC_UNMUTE_FIR		2
...
#define DMIC_HW_CIC_DECIM_MAX		31
#define DMIC_HW_FIR_DECIM_MIN		2
#define DMIC_HW_FIR_DECIM_MAX		20
#define DMIC_HW_SENS_Q28		Q_CONVERT_FLOAT(1.0, 28)
#define DMIC_HW_PDM_CLK_MIN		100000
#define DMIC_HW_DUTY_MIN		20
#define DMIC_HW_DUTY_MAX		80
...
#define LOGRAMP_TIME_COEF_Q15 -102
#define LOGRAMP_TIME_OFFS_Q0 250

/* Limits for ramp time from topology */
#define LOGRAMP_TIME_MIN_MS 10
#define LOGRAMP_TIME_MAX_MS 1000
...
#define TWO_Q27         Q_CONVERT_FLOAT(2.0, 27)
#define MINUS_TWO_Q27   Q_CONVERT_FLOAT(-2.0, 27)
#define ONE_Q20         Q_CONVERT_FLOAT(1.0, 20)
#define ONE_Q23         Q_CONVERT_FLOAT(1.0, 23)
#define LOG10_DIV20_Q27 Q_CONVERT_FLOAT(0.1151292546, 27)
...
struct dai_intel_dmic {
	...
	uint16_t enable[CONFIG_DAI_DMIC_HW_CONTROLLERS];
	struct dai_dmic_plat_fifo_data fifo;
	int32_t gain_coef;
	int32_t gain;
	int32_t startcount;
	int32_t unmute_time_ms;
