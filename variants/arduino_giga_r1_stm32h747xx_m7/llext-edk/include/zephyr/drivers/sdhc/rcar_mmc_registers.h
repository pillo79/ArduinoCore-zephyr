 ...
 * and response type
 */
#define RCAR_MMC_CMD			0x000
#define RCAR_MMC_CMD_NOSTOP		BIT(14)
#define RCAR_MMC_CMD_MULTI		BIT(13)
#define RCAR_MMC_CMD_RD			BIT(12)
#define RCAR_MMC_CMD_DATA		BIT(11)
#define RCAR_MMC_CMD_APP		BIT(6)
#define RCAR_MMC_CMD_NORMAL		(0 << 8)
#define RCAR_MMC_CMD_RSP_NONE		(3 << 8)
#define RCAR_MMC_CMD_RSP_R1		(4 << 8)
#define RCAR_MMC_CMD_RSP_R1B		(5 << 8)
#define RCAR_MMC_CMD_RSP_R2		(6 << 8)
#define RCAR_MMC_CMD_RSP_R3		(7 << 8)

/* Command arguments register for SD card */
#define RCAR_MMC_ARG			0x010
 ...
 * command sequences.
 */
#define RCAR_MMC_STOP			0x020
#define RCAR_MMC_STOP_SEC		BIT(8)
#define RCAR_MMC_STOP_STP		BIT(0)

/*
 * The block count register is used to specify the number of
 * transfer blocks at multiple block transfer.
 */
#define RCAR_MMC_SECCNT			0x028

/* The SD card response registers hold the response from the SD card */
#define RCAR_MMC_RSP10			0x030
#define RCAR_MMC_RSP32			0x040
#define RCAR_MMC_RSP54			0x050
#define RCAR_MMC_RSP76			0x060
 ...
 */
#define RCAR_MMC_INFO1			0x070
#define RCAR_MMC_INFO1_CD		BIT(5)
#define RCAR_MMC_INFO1_INSERT		BIT(4)
#define RCAR_MMC_INFO1_REMOVE		BIT(3)
#define RCAR_MMC_INFO1_CMP		BIT(2)
#define RCAR_MMC_INFO1_RSP		BIT(0)

/*
 * The SD card interrupt flag register 2 indicates the access status of the
 * SD buffer and SD card.
 */
#define RCAR_MMC_INFO2			0x078
#define RCAR_MMC_INFO2_ERR_ILA		BIT(15)
#define RCAR_MMC_INFO2_CBSY		BIT(14)
#define RCAR_MMC_INFO2_SCLKDIVEN	BIT(13)
#define RCAR_MMC_INFO2_CLEAR		BIT(11)
#define RCAR_MMC_INFO2_BWE		BIT(9)
#define RCAR_MMC_INFO2_BRE		BIT(8)
#define RCAR_MMC_INFO2_DAT0		BIT(7)
#define RCAR_MMC_INFO2_ERR_RTO		BIT(6)
#define RCAR_MMC_INFO2_ERR_ILR		BIT(5)
#define RCAR_MMC_INFO2_ERR_ILW		BIT(4)
#define RCAR_MMC_INFO2_ERR_TO		BIT(3)
#define RCAR_MMC_INFO2_ERR_END		BIT(2)
#define RCAR_MMC_INFO2_ERR_CRC		BIT(1)
#define RCAR_MMC_INFO2_ERR_IDX		BIT(0)
...
#define RCAR_MMC_CLKCTL_DIV512		BIT(7)
#define RCAR_MMC_CLKCTL_DIV256		BIT(6)
#define RCAR_MMC_CLKCTL_DIV128		BIT(5)
#define RCAR_MMC_CLKCTL_DIV64		BIT(4)
#define RCAR_MMC_CLKCTL_DIV32		BIT(3)
#define RCAR_MMC_CLKCTL_DIV16		BIT(2)
#define RCAR_MMC_CLKCTL_DIV8		BIT(1)
#define RCAR_MMC_CLKCTL_DIV4		BIT(0)
#define RCAR_MMC_CLKCTL_DIV2		0
#define RCAR_MMC_CLKCTL_RCAR_DIV1	0xff
#define RCAR_MMC_CLKCTL_OFFEN		BIT(9)
#define RCAR_MMC_CLKCTL_SCLKEN		BIT(8)
...
#define RCAR_MMC_IF_MODE_DDR		BIT(0)

/* Set of DMAC registers */
#define RCAR_MMC_DMA_MODE		0x820
#define RCAR_MMC_DMA_MODE_DIR_RD	BIT(16)
#define RCAR_MMC_DMA_MODE_WIDTH		(BIT(4) | BIT(5))
#define RCAR_MMC_DMA_MODE_ADDR_INC	BIT(0)
#define RCAR_MMC_DMA_CTL		0x828
#define RCAR_MMC_DMA_CTL_START		BIT(0)
...
#define RCAR_MMC_DMA_INFO1_END_RD2	BIT(20)
#define RCAR_MMC_DMA_INFO1_END_RD	BIT(17)
#define RCAR_MMC_DMA_INFO1_END_WR	BIT(16)
