...
fsp_err_t HW_SCE_GenerateUpdateKeyRingKeyIndexSub(const uint32_t * const InData_LC, const uint32_t * const InData_SharedKeyIndex, const uint32_t * const InData_SessionKey, const uint32_t * const InData_IV, const uint32_t * const InData_InstData, uint32_t * const OutData_InstData);
...
fsp_err_t HW_SCE_GenerateAes128KeyIndexSub(const uint32_t * const InData_KeyType, const uint32_t * const InData_SharedKeyIndex,
...
fsp_err_t HW_SCE_GenerateAes192KeyIndexSub(uint32_t *InData_KeyType, uint32_t *InData_SharedKeyIndex,
...
fsp_err_t HW_SCE_GenerateRsa1024PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey,
        uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateRsa2048PublicKeyIndexSub(const uint32_t * const InData_KeyType, const uint32_t * const InData_SharedKeyIndex,
        const uint32_t * const InData_SessionKey, const uint32_t * const InData_IV, const uint32_t * const InData_InstData, uint32_t * const OutData_KeyIndex);
fsp_err_t HW_SCE_GenerateRsa2048PrivateKeyIndexSub(const uint32_t * const InData_KeyType, const uint32_t * const InData_SharedKeyIndex,
        const uint32_t * const InData_SessionKey, const uint32_t * const InData_IV, const uint32_t * const InData_InstData, uint32_t * const OutData_KeyIndex);
...
fsp_err_t HW_SCE_GenerateUpdateKeyRingKeyIndexSub(const uint32_t * const InData_LC, const uint32_t * const InData_SharedKeyIndex,
...
fsp_err_t HW_SCE_UpdateRsa1024PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData,
        uint32_t *OutData_KeyIndex);
fsp_err_t HW_SCE_UpdateRsa2048PublicKeyIndexSub(const uint32_t * const InData_IV, const uint32_t * const InData_InstData,
        uint32_t * const OutData_KeyIndex);
fsp_err_t HW_SCE_UpdateRsa2048PrivateKeyIndexSub(const uint32_t * const InData_IV, const uint32_t * const InData_InstData,
        uint32_t * const OutData_KeyIndex);
...
fsp_err_t HW_SCE_UpdateEccPrivateKeyIndexSub(const uint32_t * const InData_CurveType, const uint32_t * const InData_Cmd, const uint32_t * const InData_IV,
...
fsp_err_t HW_SCE_EcdsaSignatureVerificationSubAdaptor(const uint32_t InData_CurveType[], const uint32_t InData_Cmd[], const uint32_t InData_KeyIndex[], const uint32_t InData_MsgDgst[], 
        const uint32_t InData_Signature[], const uint32_t InData_DomainParam[]);
...
void HW_SCE_p_func003_r1(uint32_t* ARG1);
void HW_SCE_p_func004_r1(uint32_t ARG1);
void HW_SCE_p_func005_r1(uint32_t ARG1);
void HW_SCE_p_func006(void);
void HW_SCE_p_func007(void);
void HW_SCE_p_func008(void);
void HW_SCE_p_func009(void);
void HW_SCE_p_func010_r1(uint32_t ARG1);
void HW_SCE_p_func011(uint32_t* ARG1);
void HW_SCE_p_func022_r1(void);
