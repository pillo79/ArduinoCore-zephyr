...
typedef struct
{
    union
    {
        __IOM uint8_t DACS[2];

        struct
        {
            __IOM uint8_t DACS : 8;
        } DACS_b[2];
    };
    __IM uint8_t RESERVED;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t DAMD0 : 1;
            __IOM uint8_t DAMD1 : 1;
            uint8_t             : 2;
            __IOM uint8_t DACE0 : 1;
            __IOM uint8_t DACE1 : 1;
            uint8_t             : 2;
        } DAM_b;
    };
    ...
    union
    {
        __IOM uint8_t DACADSCR;

        struct
        {
            __IOM uint8_t DACADST : 1;
            uint8_t               : 7;
        } DACADSCR_b;
    };
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t AMPPC0 : 1;
            __IOM uint8_t AMPPC1 : 1;
            __IOM uint8_t AMPPC2 : 1;
            uint8_t              : 4;
            __IOM uint8_t AMPSP  : 1;
        } AMPMC_b;
    };

    union
    {
        __IOM uint8_t AMPTRM;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t AMPE0 : 1;
            __IOM uint8_t AMPE1 : 1;
            __IOM uint8_t AMPE2 : 1;
            __IOM uint8_t AMPE3 : 1;
            uint8_t             : 3;
    ...
    union
    {
        ...
        struct
        {
            __IM uint8_t AMPMON0 : 1;
            __IM uint8_t AMPMON1 : 1;
            __IM uint8_t AMPMON2 : 1;
            __IM uint8_t AMPMON3 : 1;
            uint8_t              : 4;
        } AMPMON_b;
    };
    __IM uint8_t           RESERVED1;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t PUMP0EN : 1;
            __IOM uint8_t PUMP1EN : 1;
            __IOM uint8_t PUMP2EN : 1;
            uint8_t               : 5;
        } AMPCPC_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t AMP0TE : 1;
            __IOM uint8_t AMP1TE : 1;
            __IOM uint8_t AMP2TE : 1;
            uint8_t              : 5;
        } AMPUOTE_b;
    };
    __IOM R_OPAMP_AMPOT_Type AMPOT[3];
} R_OPAMP_Type;
...
typedef struct
{
    union
    {
        ...
        struct
        {
            __IOM uint16_t CLKDIV  : 4;
            uint16_t               : 3;
            __IOM uint16_t SDADLPM : 1;
            __IOM uint16_t VSBIAS  : 4;
            uint16_t               : 3;
            __IOM uint16_t VREFSEL : 1;
        } STC1_b;
    };
    __IM uint16_t RESERVED;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t BGRPON  : 1;
            __IOM uint8_t ADCPON  : 1;
            __IOM uint8_t ADFPWDS : 1;
            uint8_t               : 5;
        } STC2_b;
    };
    __IM uint8_t  RESERVED1;
    ...
    union
    {
        __IOM uint32_t PGAC[5];

        struct
        {
            __IOM uint32_t PGAGC : 5;  /*!< [4..0] Gain selection of a programmable gain instrumentation
                                        *   amplifier ( Gset1, Gset2, Gtotal )                                        */
            __IOM uint32_t PGAOSR : 3;
            __IOM uint32_t PGAOFS : 5;
            uint32_t              : 1;
            __IOM uint32_t PGAPOL : 1;
            __IOM uint32_t PGASEL : 1;
            ...
            __IOM uint32_t PGACTN : 3; /*!< [23..21] Coefficient (n) selection of the A/D conversion count
                                        *   (N) in AUTOSCAN                                                           */
            __IOM uint32_t PGAAVN : 2;
            __IOM uint32_t PGAAVE : 2;
            __IOM uint32_t PGAREV : 1;
            uint32_t              : 1;
            __IOM uint32_t PGACVE : 1;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t SDADSCM : 1;
            uint32_t               : 3;
            __IOM uint32_t SDADTMD : 1;
            uint32_t               : 3;
            __IOM uint32_t SDADBMP : 5;
            uint32_t               : 3;
            __IOM uint32_t PGADISA : 1;
            __IOM uint32_t PGADISC : 1;
            uint32_t               : 2;
            __IOM uint32_t PGASLFT : 1;
            uint32_t               : 11;
        } ADC1_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IM uint32_t SDADCRD : 24;
            __IM uint32_t SDADCRS : 1;
            __IM uint32_t SDADCRC : 3;
            uint32_t              : 4;
        } ADCR_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IM uint32_t SDADMVD : 24;
            __IM uint32_t SDADMVS : 1;
            __IM uint32_t SDADMVC : 3;
            uint32_t              : 4;
        } ADAR_b;
    };
    __IM uint32_t RESERVED5;
    ...
    union
    {
        __IOM uint8_t CLBSTR;

        struct
        {
            __IOM uint8_t CLBST : 1;
            uint8_t             : 7;
        } CLBSTR_b;
    };
    __IM uint8_t  RESERVED8;
...
/* ===========================================================  P  =========================================================== */
 #define R_OPAMP_AMPOT_P_TRMP_Pos    (0UL)
 #define R_OPAMP_AMPOT_P_TRMP_Msk    (0x1fUL)
/* ===========================================================  N  =========================================================== */
 #define R_OPAMP_AMPOT_N_TRMN_Pos    (0UL)
 #define R_OPAMP_AMPOT_N_TRMN_Msk    (0x1fUL)
...
/* ==========================================================  DAM  ========================================================== */
 #define R_DAC8_DAM_DACE1_Pos           (5UL)
 #define R_DAC8_DAM_DACE1_Msk           (0x20UL)
 #define R_DAC8_DAM_DACE0_Pos           (4UL)
 #define R_DAC8_DAM_DACE0_Msk           (0x10UL)
 #define R_DAC8_DAM_DAMD1_Pos           (1UL)
 #define R_DAC8_DAM_DAMD1_Msk           (0x2UL)
 #define R_DAC8_DAM_DAMD0_Pos           (0UL)
 #define R_DAC8_DAM_DAMD0_Msk           (0x1UL)
/* =========================================================  DACS  ========================================================== */
 #define R_DAC8_DACS_DACS_Pos           (0UL)
 #define R_DAC8_DACS_DACS_Msk           (0xffUL)
/* =======================================================  DACADSCR  ======================================================== */
 #define R_DAC8_DACADSCR_DACADST_Pos    (0UL)
 #define R_DAC8_DACADSCR_DACADST_Msk    (0x1UL)
/* =========================================================  DACPC  ========================================================= */
 #define R_DAC8_DACPC_PUMPEN_Pos        (0UL)
 #define R_DAC8_DACPC_PUMPEN_Msk        (0x1UL)
...
/* =========================================================  AMPMC  ========================================================= */
 #define R_OPAMP_AMPMC_AMPSP_Pos      (7UL)
 #define R_OPAMP_AMPMC_AMPSP_Msk      (0x80UL)
 #define R_OPAMP_AMPMC_AMPPC_Pos      (0UL)
 #define R_OPAMP_AMPMC_AMPPC_Msk      (0x1UL)
/* ========================================================  AMPTRM  ========================================================= */
 #define R_OPAMP_AMPTRM_AMPTRM_Pos    (0UL)
 #define R_OPAMP_AMPTRM_AMPTRM_Msk    (0x3UL)
/* ========================================================  AMPTRS  ========================================================= */
 #define R_OPAMP_AMPTRS_AMPTRS_Pos    (0UL)
 #define R_OPAMP_AMPTRS_AMPTRS_Msk    (0x3UL)
/* =========================================================  AMPC  ========================================================== */
 #define R_OPAMP_AMPC_IREFE_Pos       (7UL)
 #define R_OPAMP_AMPC_IREFE_Msk       (0x80UL)
 #define R_OPAMP_AMPC_AMPE_Pos        (0UL)
 #define R_OPAMP_AMPC_AMPE_Msk        (0x1UL)
/* ========================================================  AMPMON  ========================================================= */
 #define R_OPAMP_AMPMON_AMPMON_Pos    (0UL)
 #define R_OPAMP_AMPMON_AMPMON_Msk    (0x1UL)
/* ========================================================  AMPCPC  ========================================================= */
 #define R_OPAMP_AMPCPC_PUMPEN_Pos    (0UL)
 #define R_OPAMP_AMPCPC_PUMPEN_Msk    (0x1UL)
/* ========================================================  AMPUOTE  ======================================================== */
 #define R_OPAMP_AMPUOTE_AMPTE_Pos    (0UL)
 #define R_OPAMP_AMPUOTE_AMPTE_Msk    (0x1UL)
...
/* =========================================================  STC1  ========================================================== */
 #define R_SDADC0_STC1_VSBIAS_Pos     (8UL)
 #define R_SDADC0_STC1_VSBIAS_Msk     (0xf00UL)
 #define R_SDADC0_STC1_CLKDIV_Pos     (0UL)
 #define R_SDADC0_STC1_CLKDIV_Msk     (0xfUL)
 #define R_SDADC0_STC1_SDADLPM_Pos    (7UL)
 #define R_SDADC0_STC1_SDADLPM_Msk    (0x80UL)
 #define R_SDADC0_STC1_VREFSEL_Pos    (15UL)
 #define R_SDADC0_STC1_VREFSEL_Msk    (0x8000UL)
/* =========================================================  STC2  ========================================================== */
 #define R_SDADC0_STC2_BGRPON_Pos     (0UL)
 #define R_SDADC0_STC2_BGRPON_Msk     (0x1UL)
 #define R_SDADC0_STC2_ADFPWDS_Pos    (2UL)
 #define R_SDADC0_STC2_ADFPWDS_Msk    (0x4UL)
 #define R_SDADC0_STC2_ADCPON_Pos     (1UL)
 #define R_SDADC0_STC2_ADCPON_Msk     (0x2UL)
/* =========================================================  PGAC  ========================================================== */
 #define R_SDADC0_PGAC_PGAASN_Pos     (31UL)
 #define R_SDADC0_PGAC_PGAASN_Msk     (0x80000000UL)
 #define R_SDADC0_PGAC_PGACVE_Pos     (30UL)
 #define R_SDADC0_PGAC_PGACVE_Msk     (0x40000000UL)
 #define R_SDADC0_PGAC_PGAREV_Pos     (28UL)
 #define R_SDADC0_PGAC_PGAREV_Msk     (0x10000000UL)
 #define R_SDADC0_PGAC_PGAAVE_Pos     (26UL)
 #define R_SDADC0_PGAC_PGAAVE_Msk     (0xc000000UL)
 #define R_SDADC0_PGAC_PGAAVN_Pos     (24UL)
 #define R_SDADC0_PGAC_PGAAVN_Msk     (0x3000000UL)
 #define R_SDADC0_PGAC_PGACTN_Pos     (21UL)
 #define R_SDADC0_PGAC_PGACTN_Msk     (0xe00000UL)
 #define R_SDADC0_PGAC_PGACTM_Pos     (16UL)
 #define R_SDADC0_PGAC_PGACTM_Msk     (0x1f0000UL)
 #define R_SDADC0_PGAC_PGASEL_Pos     (15UL)
 #define R_SDADC0_PGAC_PGASEL_Msk     (0x8000UL)
 #define R_SDADC0_PGAC_PGAPOL_Pos     (14UL)
 #define R_SDADC0_PGAC_PGAPOL_Msk     (0x4000UL)
 #define R_SDADC0_PGAC_PGAOFS_Pos     (8UL)
 #define R_SDADC0_PGAC_PGAOFS_Msk     (0x1f00UL)
 #define R_SDADC0_PGAC_PGAOSR_Pos     (5UL)
 #define R_SDADC0_PGAC_PGAOSR_Msk     (0xe0UL)
 #define R_SDADC0_PGAC_PGAGC_Pos      (0UL)
 #define R_SDADC0_PGAC_PGAGC_Msk      (0x1fUL)
/* =========================================================  ADC1  ========================================================== */
 #define R_SDADC0_ADC1_PGASLFT_Pos    (20UL)
 #define R_SDADC0_ADC1_PGASLFT_Msk    (0x100000UL)
 #define R_SDADC0_ADC1_PGADISC_Pos    (17UL)
 #define R_SDADC0_ADC1_PGADISC_Msk    (0x20000UL)
 #define R_SDADC0_ADC1_PGADISA_Pos    (16UL)
 #define R_SDADC0_ADC1_PGADISA_Msk    (0x10000UL)
 #define R_SDADC0_ADC1_SDADBMP_Pos    (8UL)
 #define R_SDADC0_ADC1_SDADBMP_Msk    (0x1f00UL)
 #define R_SDADC0_ADC1_SDADTMD_Pos    (4UL)
 #define R_SDADC0_ADC1_SDADTMD_Msk    (0x10UL)
 #define R_SDADC0_ADC1_SDADSCM_Pos    (0UL)
 #define R_SDADC0_ADC1_SDADSCM_Msk    (0x1UL)
/* =========================================================  ADC2  ========================================================== */
 #define R_SDADC0_ADC2_SDADST_Pos     (0UL)
 #define R_SDADC0_ADC2_SDADST_Msk     (0x1UL)
/* =========================================================  ADCR  ========================================================== */
 #define R_SDADC0_ADCR_SDADCRC_Pos    (25UL)
 #define R_SDADC0_ADCR_SDADCRC_Msk    (0xe000000UL)
 #define R_SDADC0_ADCR_SDADCRS_Pos    (24UL)
 #define R_SDADC0_ADCR_SDADCRS_Msk    (0x1000000UL)
 #define R_SDADC0_ADCR_SDADCRD_Pos    (0UL)
 #define R_SDADC0_ADCR_SDADCRD_Msk    (0xffffffUL)
/* =========================================================  ADAR  ========================================================== */
 #define R_SDADC0_ADAR_SDADMVC_Pos    (25UL)
 #define R_SDADC0_ADAR_SDADMVC_Msk    (0xe000000UL)
 #define R_SDADC0_ADAR_SDADMVS_Pos    (24UL)
 #define R_SDADC0_ADAR_SDADMVS_Msk    (0x1000000UL)
 #define R_SDADC0_ADAR_SDADMVD_Pos    (0UL)
 #define R_SDADC0_ADAR_SDADMVD_Msk    (0xffffffUL)
/* =========================================================  CLBC  ========================================================== */
 #define R_SDADC0_CLBC_CLBMD_Pos      (0UL)
 #define R_SDADC0_CLBC_CLBMD_Msk      (0x3UL)
/* ========================================================  CLBSTR  ========================================================= */
 #define R_SDADC0_CLBSTR_CLBST_Pos    (0UL)
 #define R_SDADC0_CLBSTR_CLBST_Msk    (0x1UL)
/* ========================================================  CLBSSR  ========================================================= */
 #define R_SDADC0_CLBSSR_CLBSS_Pos    (0UL)
 #define R_SDADC0_CLBSSR_CLBSS_Msk    (0x1UL)
