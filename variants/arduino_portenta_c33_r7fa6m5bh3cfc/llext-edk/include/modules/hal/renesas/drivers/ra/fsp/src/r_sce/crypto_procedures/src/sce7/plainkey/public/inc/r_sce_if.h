...
/* RSA HASH type. */
#define HW_SCE_RSA_HASH_MD5                                     (0x01)
#define HW_SCE_RSA_HASH_SHA1                                    (0x02)
#define HW_SCE_RSA_HASH_SHA256                                  (0x03)

/* For ECC operation. */
#define HW_SCE_ECC_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE    (4U)
#define HW_SCE_ECC_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE    (4U)
//#define HW_SCE_ECC_PUBLIC_KEY_MANAGEMENT_INFO_WORD_SIZE     (8U)
...
#define HW_SCE_PRIVATE_KEY_WRAPPING_WORD_SIZE               (8U)
#define HW_SCE_ECC_PRIVATE_PLAIN_KEY_LENGTH_BYTE_SIZE       (48U)
...
/* Key update. */
#define HW_SCE_UPDATE_KEY_RING_INDEX_WORD_SIZE  (16U)
#define HW_SCE_INSTALL_KEY_RING_INDEX           (0U)
...
/* ECC P-192/224/256/384 private key index data structure */
typedef struct sce_ecc_private_key_index
{
    ...
    struct
    {
        uint8_t     key[HW_SCE_ECC_PRIVATE_PLAIN_KEY_LENGTH_BYTE_SIZE];
    }
    plain_value;
} sce_ecc_private_key_index_t;

/* ECC P-192/224/256/384 key index pair structure */
...
fsp_err_t HW_SCE_FwIntegrityCheck(uint32_t *InData_Program, uint32_t MAX_CNT);
...
fsp_err_t HW_SCE_GenerateEccP192PublicPlainKeyIndex(uint8_t *plain_key, sce_ecc_public_key_index_t *key_index);
fsp_err_t HW_SCE_GenerateEccP192PrivatePlainKeyIndex(uint8_t *plain_key, sce_ecc_private_key_index_t *key_index);
...
fsp_err_t HW_SCE_GenerateRsa2048RandomKeyIndex(uint32_t *key_type, sce_rsa2048_key_pair_index_t *key_pair_index);
...
fsp_err_t HW_SCE_GenerateEccP192RandomKeyIndex(uint32_t *indata_curvetype, uint32_t *key_type, sce_ecc_key_pair_index_t *key_pair_index);
fsp_err_t HW_SCE_GenerateEccP224RandomKeyIndex(uint32_t *indata_curvetype, uint32_t *key_type, sce_ecc_key_pair_index_t *key_pair_index);
fsp_err_t HW_SCE_GenerateEccP256RandomKeyIndex(uint32_t *indata_curvetype, uint32_t *key_type, sce_ecc_key_pair_index_t *key_pair_index);
fsp_err_t HW_SCE_GenerateEccP384RandomKeyIndex(uint32_t *indata_curvetype, uint32_t *key_type, sce_ecc_key_pair_index_t *key_pair_index);
...
fsp_err_t HW_SCE_GenerateUpdateKeyRingKeyIndex(lifecycle_t lifecycle, uint8_t *encrypted_provisioning_key, uint8_t *iv,
        uint8_t *encrypted_key, sce_aes_key_index_t *key_index);
uint32_t HW_SCE_GetVersion(void);
fsp_err_t HW_SCE_GenerateAes128PlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint8_t *encrypted_key,
        sce_aes_key_index_t *key_index);
fsp_err_t HW_SCE_GenerateAes192PlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint8_t *encrypted_key,
        sce_aes_key_index_t *key_index);
fsp_err_t HW_SCE_GenerateAes256PlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint8_t *encrypted_key,
        sce_aes_key_index_t *key_index);
...
fsp_err_t HW_SCE_GenerateRsa2048PublicPlainKeyIndex(uint8_t *plain_key, uint32_t *iv,  uint32_t *inst_data, sce_rsa2048_public_key_index_t *key_index);
fsp_err_t HW_SCE_GenerateRsa2048PrivatePlainKeyIndex(uint8_t *plain_key, uint32_t *iv,  uint32_t *inst_data, sce_rsa2048_private_key_index_t *key_index);
...
fsp_err_t HW_SCE_GenerateEccP256PublicPlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint8_t *encrypted_key,
         sce_aes_key_index_t *key_index);
...
fsp_err_t HW_SCE_GenerateEccP256PrivatePlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint32_t *encrypted_key, sce_aes_key_index_t *key_index);

fsp_err_t HW_SCE_GenerateEccP384PrivatePlainKeyIndex(uint8_t *plain_key, sce_ecc_private_key_index_t *key_index);
fsp_err_t HW_SCE_GenerateSha256HmacPlainKeyIndex(uint8_t *encrypted_provisioning_key, uint32_t *iv, uint32_t *encrypted_key, sce_hmac_sha_key_index_t *key_index);
...
fsp_err_t HW_SCE_UpdateAes128KeyIndex(uint8_t *update_key, sce_aes_key_index_t *key_index);
...
fsp_err_t HW_SCE_EcdhP384Init(sce_ecdh_handle_t *handle, uint32_t key_type, uint32_t use_key_id);
fsp_err_t HW_SCE_EcdhP384ReadPublicKey(sce_ecdh_handle_t *handle, sce_ecc_public_key_index_t *public_key_index,
        uint8_t *public_key_data, sce_ecdsa_byte_data_t *signature, sce_ecc_public_key_index_t *key_index);
fsp_err_t HW_SCE_EcdhP384MakePublicKey(sce_ecdh_handle_t *handle, sce_ecc_public_key_index_t *public_key_index,
        sce_ecc_private_key_index_t *private_key_index, uint8_t *public_key, sce_ecdsa_byte_data_t *signature,
        sce_ecc_private_key_index_t *key_index);
fsp_err_t HW_SCE_EcdhP384CalculateSharedSecretIndex(sce_ecdh_handle_t *handle,
        sce_ecc_public_key_index_t *public_key_index, sce_ecc_private_key_index_t *private_key_index,
        sce_ecdh_key_index_t *shared_secret_index);
fsp_err_t HW_SCE_EcdhP384KeyDerivation(sce_ecdh_handle_t *handle, sce_ecdh_key_index_t *shared_secret_index,
        uint32_t algorithm_id, uint8_t *other_info, uint32_t other_info_length, sce_aes_key_index_t *key_index);
