...
typedef struct
{
    union
    {
        ...
        struct
        {
            __IOM uint8_t LBAS  : 2;
            __IOM uint8_t LDTY  : 3;
            __IOM uint8_t LWAVE : 1;
            __IOM uint8_t MDSET : 2;
        } LCDM0_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t LCDVLM : 1;
            uint8_t              : 2;
            __IOM uint8_t LCDSEL : 1;
            __IOM uint8_t BLON   : 1;
            __IOM uint8_t VLCON  : 1;  /*!< [5..5] Voltage boost circuit or capacitor split circuit operation
                                        *   enable/disable                                                            */
            __IOM uint8_t SCOC  : 1;
            __IOM uint8_t LCDON : 1;
        } LCDM1_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t VLCD   : 5;
            uint8_t              : 2;
            __IOM uint8_t MDSET2 : 1;
        } VLCD_b;
    };
...
/* =========================================================  LCDM0  ========================================================= */
 #define R_SLCDC_LCDM0_MDSET_Pos     (6UL)
 #define R_SLCDC_LCDM0_MDSET_Msk     (0xc0UL)
 #define R_SLCDC_LCDM0_LWAVE_Pos     (5UL)
 #define R_SLCDC_LCDM0_LWAVE_Msk     (0x20UL)
 #define R_SLCDC_LCDM0_LDTY_Pos      (2UL)
 #define R_SLCDC_LCDM0_LDTY_Msk      (0x1cUL)
 #define R_SLCDC_LCDM0_LBAS_Pos      (0UL)
 #define R_SLCDC_LCDM0_LBAS_Msk      (0x3UL)
/* =========================================================  LCDM1  ========================================================= */
 #define R_SLCDC_LCDM1_LCDON_Pos     (7UL)
 #define R_SLCDC_LCDM1_LCDON_Msk     (0x80UL)
 #define R_SLCDC_LCDM1_SCOC_Pos      (6UL)
 #define R_SLCDC_LCDM1_SCOC_Msk      (0x40UL)
 #define R_SLCDC_LCDM1_VLCON_Pos     (5UL)
 #define R_SLCDC_LCDM1_VLCON_Msk     (0x20UL)
 #define R_SLCDC_LCDM1_BLON_Pos      (4UL)
 #define R_SLCDC_LCDM1_BLON_Msk      (0x10UL)
 #define R_SLCDC_LCDM1_LCDSEL_Pos    (3UL)
 #define R_SLCDC_LCDM1_LCDSEL_Msk    (0x8UL)
 #define R_SLCDC_LCDM1_LCDVLM_Pos    (0UL)
 #define R_SLCDC_LCDM1_LCDVLM_Msk    (0x1UL)
/* =========================================================  LCDC0  ========================================================= */
 #define R_SLCDC_LCDC0_LCDC_Pos      (0UL)
 #define R_SLCDC_LCDC0_LCDC_Msk      (0x3fUL)
/* =========================================================  VLCD  ========================================================== */
 #define R_SLCDC_VLCD_MDSET2_Pos     (7UL)
 #define R_SLCDC_VLCD_MDSET2_Msk     (0x80UL)
 #define R_SLCDC_VLCD_VLCD_Pos       (0UL)
 #define R_SLCDC_VLCD_VLCD_Msk       (0x1fUL)
/* ==========================================================  SEG  ========================================================== */
 #define R_SLCDC_SEG_A_Pos           (0UL)
 #define R_SLCDC_SEG_A_Msk           (0xfUL)
 #define R_SLCDC_SEG_B_Pos           (4UL)
 #define R_SLCDC_SEG_B_Msk           (0xf0UL)
