...
#define BSP_TZ_CFG_PSARB                                                                           \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 1) |                                      \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 31) | 0x33f4f9)
#endif
...
#define BSP_TZ_CFG_PSARC                                                                           \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) |                                       \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 31) | 0x7fffcef4)
#endif
...
#define BSP_TZ_CFG_PSARD                                                                           \
	((((RA_NOT_DEFINED > 0) ? 0U : 1U) << 0) |                                      \
	 ...
	 (((RA_NOT_DEFINED > 0) ? 0U : 1U) << 22) | 0xffae07f0)
#endif
...
#define BSP_CFG_ROM_REG_OFS1_SEL                                                                   \
	(0xFFFFF8F8U | ((0U << 0U)) | ((0U << 2U)) | ((BSP_CFG_CLOCKS_SECURE == 0) ? 0x700U : 0U))
#else
