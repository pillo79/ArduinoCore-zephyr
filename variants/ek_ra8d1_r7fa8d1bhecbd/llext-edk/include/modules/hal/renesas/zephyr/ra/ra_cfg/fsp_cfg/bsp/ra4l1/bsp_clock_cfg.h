...
#define BSP_CFG_HOCO_FREQUENCY 1
...
#define BSP_CFG_UARTA0_CLOCK_SOURCE CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(uarta0)))
#define BSP_CFG_UARTA1_CLOCK_SOURCE CGC_CLK_SRC(DT_CLOCKS_CTLR(DT_NODELABEL(uarta1)))
