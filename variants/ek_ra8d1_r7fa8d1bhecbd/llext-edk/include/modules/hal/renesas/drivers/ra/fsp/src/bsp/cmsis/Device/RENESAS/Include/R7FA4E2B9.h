...
typedef struct
{
    ...
    union
    {
        ...
        {
            uint32_t               : 1;
            __IOM uint32_t PSARB1  : 1;
            __IOM uint32_t PSARB2  : 1;
            __IOM uint32_t PSARB3  : 1;
            uint32_t               : 2;
            __IM uint32_t  PSARB6  : 1;
            __IOM uint32_t PSARB7  : 1;
            ...
            __IM uint32_t PSARB16  : 1;
            uint32_t               : 1;
            __IOM uint32_t PSARB18 : 1;
            __IOM uint32_t PSARB19 : 1;
            uint32_t               : 2;
            __IOM uint32_t PSARB22 : 1;
            __IOM uint32_t PSARB23 : 1;
            __IOM uint32_t PSARB24 : 1;
            __IOM uint32_t PSARB25 : 1;
            __IOM uint32_t PSARB26 : 1;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PSARC0  : 1;
            __IOM uint32_t PSARC1  : 1;
            uint32_t               : 1;
            __IOM uint32_t PSARC3  : 1;
            uint32_t               : 4;
            __IOM uint32_t PSARC8  : 1;
            uint32_t               : 3;
            __IOM uint32_t PSARC12 : 1;
            __IOM uint32_t PSARC13 : 1;
            uint32_t               : 6;
            __IOM uint32_t PSARC20 : 1;
            uint32_t               : 6;
            __IOM uint32_t PSARC27 : 1;
            uint32_t               : 3;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PSARD0  : 1;
            __IOM uint32_t PSARD1  : 1;
            __IOM uint32_t PSARD2  : 1;
            __IOM uint32_t PSARD3  : 1;
            uint32_t               : 7;
            ...
            uint32_t               : 2;
            __IOM uint32_t PSARD19 : 1;
            __IOM uint32_t PSARD20 : 1;
            uint32_t               : 1;
            __IOM uint32_t PSARD22 : 1;
            uint32_t               : 2;
            __IOM uint32_t PSARD25 : 1;
            __IOM uint32_t PSARD26 : 1;
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PSARE0  : 1;
            __IOM uint32_t PSARE1  : 1;
            __IOM uint32_t PSARE2  : 1;
            uint32_t               : 11;
            __IOM uint32_t PSARE14 : 1;
            __IOM uint32_t PSARE15 : 1;
            uint32_t               : 6;
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint32_t MSSAR2 : 1;
            __IOM uint32_t MSSAR3 : 1;
            uint32_t              : 28;
        } MSSAR_b;
    };
    ...
    union
    {
        __IOM uint32_t DFSAMON;

        struct
        {
            uint32_t           : 10;
            __IOM uint32_t DFS : 6;
            uint32_t           : 16;
        } DFSAMON_b;
    };
    ...
    union
    {
        __IOM uint32_t SSAMONA;

        struct
        {
            uint32_t           : 13;
            __IOM uint32_t SS2 : 8;
            uint32_t           : 11;
        } SSAMONA_b;
    };
    ...
    union
    {
        __IOM uint32_t SSAMONB;

        struct
        {
            uint32_t           : 10;
            __IOM uint32_t SS1 : 11;
            uint32_t           : 11;
        } SSAMONB_b;
    };
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t TZFSAR;

        struct
        {
            __IOM uint32_t TZFSA0 : 1;
            uint32_t              : 31;
        } TZFSAR_b;
    };
} R_TZF_Type;
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t SCACTL;

        struct
        {
            __IOM uint32_t ENS : 1;
            uint32_t           : 31;
        } SCACTL_b;
    };
    ...
    union
    {
        __IOM uint32_t CAPRCR;

        struct
        {
            __IOM uint32_t PRCR : 1;
            __IOM uint32_t KW   : 7;
            uint32_t            : 24;
        } CAPRCR_b;
    };
...
typedef struct
{
    union
    {
        ...
        struct
        {
            ...
            __IOM uint16_t ADR02 : 1;  /*!< [2..2] Local Address Setting at Address 2 (recording device
                                        *   2)                                                                        */
            __IOM uint16_t ADR03 : 1;
            __IOM uint16_t ADR04 : 1;
            __IOM uint16_t ADR05 : 1;
            __IOM uint16_t ADR06 : 1;
            __IOM uint16_t ADR07 : 1;
            __IOM uint16_t ADR08 : 1;
            __IOM uint16_t ADR09 : 1;  /*!< [9..9] Local Address Setting at Address 9 (recording device
                                        *   3)                                                                        */
            __IOM uint16_t ADR10 : 1;
            __IOM uint16_t ADR11 : 1;  /*!< [11..11] Local Address Setting at Address 11 (playback device
                                        *   3)                                                                        */
            __IOM uint16_t ADR12 : 1;
            __IOM uint16_t ADR13 : 1;
            __IOM uint16_t ADR14 : 1;
            uint16_t             : 1;
        } CADR_b;
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            __IOM uint8_t CESEL : 2;   /*!< [3..2] Communication Complete Interrupt (INTCE) Generation Timing
                                        *   Select                                                                    */
            __IOM uint8_t STERRD : 1;
            __IOM uint8_t BLERRD : 1;
            __IOM uint8_t CINTMK : 1;
            __IOM uint8_t CDFC   : 1;
        } CECCTL1_b;
    };
    __IM uint8_t RESERVED;
    ...
    union
    {
        __IOM uint16_t STATB;

        struct
        {
            __IOM uint16_t STATB : 9;
            uint16_t             : 7;
        } STATB_b;
    };
    ...
    union
    {
        __IOM uint8_t CECEXMD;

        struct
        {
            uint8_t                  : 4;
            __IOM uint8_t LERPLEN    : 1;
            __IOM uint8_t RERCVEN    : 1;
            uint8_t                  : 1;
            __IOM uint8_t RCVINTDSEL : 1;
        } CECEXMD_b;
    };
    __IM uint8_t RESERVED2;
    ...
    union
    {
        __IOM uint8_t CECEXMON;

        struct
        {
            __IM uint8_t CECLNMON : 1;
            __IM uint8_t ACKF     : 1;
            uint8_t               : 6;
        } CECEXMON_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IM uint8_t OERR   : 1;
            __IM uint8_t UERR   : 1;
            __IM uint8_t ACKERR : 1;
            __IM uint8_t TERR   : 1;
            __IM uint8_t TXERR  : 1;
            __IM uint8_t AERR   : 1;
            __IM uint8_t BLERR  : 1;
            uint8_t             : 1;
        } CECES_b;
    };
    ...
    union
    {
        ...
        {
            __IM uint8_t ADRF  : 1;
            __IM uint8_t BUSST : 1;
            __IM uint8_t TXST  : 1;
            __IM uint8_t EOMF  : 1;
            __IM uint8_t ITCEF : 1;
            uint8_t            : 2;
            __IM uint8_t SFTST : 1;
        } CECS_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __OM uint8_t OCTRG   : 1;
            __OM uint8_t UCTRG   : 1;
            __OM uint8_t ACKCTRG : 1;
            __OM uint8_t TCTRG   : 1;
            __OM uint8_t TXCTRG  : 1;
            __OM uint8_t ACTRG   : 1;
            __OM uint8_t BLCTRG  : 1;
            uint8_t              : 1;
        } CECFC_b;
    };
    ...
    union
    {
        __IOM uint8_t CECCTL0;

        struct
        {
            __IOM uint8_t EOM     : 1;
            __IOM uint8_t CECRXEN : 1;
            __OM uint8_t  TXTRG   : 1;
            __IOM uint8_t CCL     : 3;
            __IOM uint8_t ACKTEN  : 1;
            __IOM uint8_t CECE    : 1;
        } CECCTL0_b;
    };
} R_CEC_Type;
...
/* =========================================================  PSARB  ========================================================= */
 #define R_PSCU_PSARB_PSARB1_Pos     (1UL)
 #define R_PSCU_PSARB_PSARB1_Msk     (0x2UL)
 #define R_PSCU_PSARB_PSARB2_Pos     (2UL)
 #define R_PSCU_PSARB_PSARB2_Msk     (0x4UL)
 #define R_PSCU_PSARB_PSARB3_Pos     (3UL)
 #define R_PSCU_PSARB_PSARB3_Msk     (0x8UL)
 #define R_PSCU_PSARB_PSARB6_Pos     (6UL)
 #define R_PSCU_PSARB_PSARB6_Msk     (0x40UL)
 #define R_PSCU_PSARB_PSARB7_Pos     (7UL)
 #define R_PSCU_PSARB_PSARB7_Msk     (0x80UL)
 ...
 #define R_PSCU_PSARB_PSARB23_Pos    (23UL)
 #define R_PSCU_PSARB_PSARB23_Msk    (0x800000UL)
 #define R_PSCU_PSARB_PSARB24_Pos    (24UL)
 #define R_PSCU_PSARB_PSARB24_Msk    (0x1000000UL)
 #define R_PSCU_PSARB_PSARB25_Pos    (25UL)
 #define R_PSCU_PSARB_PSARB25_Msk    (0x2000000UL)
 #define R_PSCU_PSARB_PSARB26_Pos    (26UL)
 #define R_PSCU_PSARB_PSARB26_Msk    (0x4000000UL)
...
/* =========================================================  PSARC  ========================================================= */
 ...
 #define R_PSCU_PSARC_PSARC3_Pos     (3UL)
 #define R_PSCU_PSARC_PSARC3_Msk     (0x8UL)
 ...
 #define R_PSCU_PSARC_PSARC20_Pos    (20UL)
 #define R_PSCU_PSARC_PSARC20_Msk    (0x100000UL)
...
/* =========================================================  PSARD  ========================================================= */
 #define R_PSCU_PSARD_PSARD0_Pos     (0UL)
 #define R_PSCU_PSARD_PSARD0_Msk     (0x1UL)
 #define R_PSCU_PSARD_PSARD1_Pos     (1UL)
 #define R_PSCU_PSARD_PSARD1_Msk     (0x2UL)
 #define R_PSCU_PSARD_PSARD2_Pos     (2UL)
 #define R_PSCU_PSARD_PSARD2_Msk     (0x4UL)
 #define R_PSCU_PSARD_PSARD3_Pos     (3UL)
 #define R_PSCU_PSARD_PSARD3_Msk     (0x8UL)
 ...
 #define R_PSCU_PSARD_PSARD19_Pos    (19UL)
 #define R_PSCU_PSARD_PSARD19_Msk    (0x80000UL)
 ...
 #define R_PSCU_PSARD_PSARD25_Pos    (25UL)
 #define R_PSCU_PSARD_PSARD25_Msk    (0x2000000UL)
 #define R_PSCU_PSARD_PSARD26_Pos    (26UL)
 #define R_PSCU_PSARD_PSARD26_Msk    (0x4000000UL)
...
/* =========================================================  PSARE  ========================================================= */
 #define R_PSCU_PSARE_PSARE0_Pos     (0UL)
 #define R_PSCU_PSARE_PSARE0_Msk     (0x1UL)
 ...
 #define R_PSCU_PSARE_PSARE14_Pos    (14UL)
 #define R_PSCU_PSARE_PSARE14_Msk    (0x4000UL)
 #define R_PSCU_PSARE_PSARE15_Pos    (15UL)
 #define R_PSCU_PSARE_PSARE15_Msk    (0x8000UL)
...
/* =========================================================  MSSAR  ========================================================= */
 ...
 #define R_PSCU_MSSAR_MSSAR2_Pos     (2UL)
 #define R_PSCU_MSSAR_MSSAR2_Msk     (0x4UL)
 #define R_PSCU_MSSAR_MSSAR3_Pos     (3UL)
 #define R_PSCU_MSSAR_MSSAR3_Msk     (0x8UL)
/* =======================================================  CFSAMONA  ======================================================== */
 #define R_PSCU_CFSAMONA_CFS2_Pos    (15UL)
 #define R_PSCU_CFSAMONA_CFS2_Msk    (0xff8000UL)
/* =======================================================  CFSAMONB  ======================================================== */
 #define R_PSCU_CFSAMONB_CFS1_Pos    (10UL)
 #define R_PSCU_CFSAMONB_CFS1_Msk    (0xfffc00UL)
/* ========================================================  DFSAMON  ======================================================== */
 #define R_PSCU_DFSAMON_DFS_Pos      (10UL)
 #define R_PSCU_DFSAMON_DFS_Msk      (0xfc00UL)
/* ========================================================  SSAMONA  ======================================================== */
 #define R_PSCU_SSAMONA_SS2_Pos      (13UL)
 #define R_PSCU_SSAMONA_SS2_Msk      (0x1fe000UL)
/* ========================================================  SSAMONB  ======================================================== */
 #define R_PSCU_SSAMONB_SS1_Pos      (10UL)
 #define R_PSCU_SSAMONB_SS1_Msk      (0x1ffc00UL)
/* ========================================================  DLMMON  ========================================================= */
...
/* ========================================================  TZFSAR  ========================================================= */
 #define R_TZF_TZFSAR_TZFSA0_Pos    (0UL)
 #define R_TZF_TZFSAR_TZFSA0_Msk    (0x1UL)
...
/* ========================================================  CCACTL  ========================================================= */
 #define R_CACHE_CCACTL_ENC_Pos     (0UL)
 #define R_CACHE_CCACTL_ENC_Msk     (0x1UL)
/* ========================================================  CCAFCT  ========================================================= */
 #define R_CACHE_CCAFCT_FC_Pos      (0UL)
 #define R_CACHE_CCAFCT_FC_Msk      (0x1UL)
/* ========================================================  CCALCF  ========================================================= */
 #define R_CACHE_CCALCF_CC_Pos      (0UL)
 #define R_CACHE_CCALCF_CC_Msk      (0x3UL)
/* ========================================================  SCACTL  ========================================================= */
 #define R_CACHE_SCACTL_ENS_Pos     (0UL)
 #define R_CACHE_SCACTL_ENS_Msk     (0x1UL)
/* ========================================================  SCAFCT  ========================================================= */
 #define R_CACHE_SCAFCT_FS_Pos      (0UL)
 #define R_CACHE_SCAFCT_FS_Msk      (0x1UL)
/* ========================================================  SCALCF  ========================================================= */
 #define R_CACHE_SCALCF_CS_Pos      (0UL)
 #define R_CACHE_SCALCF_CS_Msk      (0x3UL)
/* ========================================================  CAPOAD  ========================================================= */
 #define R_CACHE_CAPOAD_OAD_Pos     (0UL)
 #define R_CACHE_CAPOAD_OAD_Msk     (0x1UL)
/* ========================================================  CAPRCR  ========================================================= */
 #define R_CACHE_CAPRCR_PRCR_Pos    (0UL)
 #define R_CACHE_CAPRCR_PRCR_Msk    (0x1UL)
 #define R_CACHE_CAPRCR_KW_Pos      (1UL)
 #define R_CACHE_CAPRCR_KW_Msk      (0xfeUL)
...
/* =========================================================  CADR  ========================================================== */
 #define R_CEC_CADR_ADR00_Pos            (0UL)
 #define R_CEC_CADR_ADR00_Msk            (0x1UL)
 #define R_CEC_CADR_ADR01_Pos            (1UL)
 #define R_CEC_CADR_ADR01_Msk            (0x2UL)
 #define R_CEC_CADR_ADR02_Pos            (2UL)
 #define R_CEC_CADR_ADR02_Msk            (0x4UL)
 #define R_CEC_CADR_ADR03_Pos            (3UL)
 #define R_CEC_CADR_ADR03_Msk            (0x8UL)
 #define R_CEC_CADR_ADR04_Pos            (4UL)
 #define R_CEC_CADR_ADR04_Msk            (0x10UL)
 #define R_CEC_CADR_ADR05_Pos            (5UL)
 #define R_CEC_CADR_ADR05_Msk            (0x20UL)
 #define R_CEC_CADR_ADR06_Pos            (6UL)
 #define R_CEC_CADR_ADR06_Msk            (0x40UL)
 #define R_CEC_CADR_ADR07_Pos            (7UL)
 #define R_CEC_CADR_ADR07_Msk            (0x80UL)
 #define R_CEC_CADR_ADR08_Pos            (8UL)
 #define R_CEC_CADR_ADR08_Msk            (0x100UL)
 #define R_CEC_CADR_ADR09_Pos            (9UL)
 #define R_CEC_CADR_ADR09_Msk            (0x200UL)
 #define R_CEC_CADR_ADR10_Pos            (10UL)
 #define R_CEC_CADR_ADR10_Msk            (0x400UL)
 #define R_CEC_CADR_ADR11_Pos            (11UL)
 #define R_CEC_CADR_ADR11_Msk            (0x800UL)
 #define R_CEC_CADR_ADR12_Pos            (12UL)
 #define R_CEC_CADR_ADR12_Msk            (0x1000UL)
 #define R_CEC_CADR_ADR13_Pos            (13UL)
 #define R_CEC_CADR_ADR13_Msk            (0x2000UL)
 #define R_CEC_CADR_ADR14_Pos            (14UL)
 #define R_CEC_CADR_ADR14_Msk            (0x4000UL)
/* ========================================================  CECCTL1  ======================================================== */
 #define R_CEC_CECCTL1_SFT_Pos           (0UL)
 #define R_CEC_CECCTL1_SFT_Msk           (0x3UL)
 #define R_CEC_CECCTL1_CESEL_Pos         (2UL)
 #define R_CEC_CECCTL1_CESEL_Msk         (0xcUL)
 #define R_CEC_CECCTL1_STERRD_Pos        (4UL)
 #define R_CEC_CECCTL1_STERRD_Msk        (0x10UL)
 #define R_CEC_CECCTL1_BLERRD_Pos        (5UL)
 #define R_CEC_CECCTL1_BLERRD_Msk        (0x20UL)
 #define R_CEC_CECCTL1_CINTMK_Pos        (6UL)
 #define R_CEC_CECCTL1_CINTMK_Msk        (0x40UL)
 #define R_CEC_CECCTL1_CDFC_Pos          (7UL)
 #define R_CEC_CECCTL1_CDFC_Msk          (0x80UL)
/* =========================================================  STATB  ========================================================= */
 #define R_CEC_STATB_STATB_Pos           (0UL)
 #define R_CEC_STATB_STATB_Msk           (0x1ffUL)
/* =========================================================  STATL  ========================================================= */
 #define R_CEC_STATL_STATL_Pos           (0UL)
 #define R_CEC_STATL_STATL_Msk           (0x1ffUL)
/* =========================================================  LGC0L  ========================================================= */
 #define R_CEC_LGC0L_LGC0L_Pos           (0UL)
 #define R_CEC_LGC0L_LGC0L_Msk           (0x1ffUL)
/* =========================================================  LGC1L  ========================================================= */
 #define R_CEC_LGC1L_LGC1L_Pos           (0UL)
 #define R_CEC_LGC1L_LGC1L_Msk           (0x1ffUL)
/* =========================================================  DATB  ========================================================== */
 #define R_CEC_DATB_DATB_Pos             (0UL)
 #define R_CEC_DATB_DATB_Msk             (0x1ffUL)
/* =========================================================  NOMT  ========================================================== */
 #define R_CEC_NOMT_NOMT_Pos             (0UL)
 #define R_CEC_NOMT_NOMT_Msk             (0x1ffUL)
/* ========================================================  STATLL  ========================================================= */
 #define R_CEC_STATLL_STATLL_Pos         (0UL)
 #define R_CEC_STATLL_STATLL_Msk         (0x1ffUL)
/* ========================================================  STATLH  ========================================================= */
 #define R_CEC_STATLH_STATLH_Pos         (0UL)
 #define R_CEC_STATLH_STATLH_Msk         (0x1ffUL)
/* ========================================================  STATBL  ========================================================= */
 #define R_CEC_STATBL_STATBL_Pos         (0UL)
 #define R_CEC_STATBL_STATBL_Msk         (0x1ffUL)
/* ========================================================  STATBH  ========================================================= */
 #define R_CEC_STATBH_STATBH_Pos         (0UL)
 #define R_CEC_STATBH_STATBH_Msk         (0x1ffUL)
/* ========================================================  LGC0LL  ========================================================= */
 #define R_CEC_LGC0LL_LGC0LL_Pos         (0UL)
 #define R_CEC_LGC0LL_LGC0LL_Msk         (0x1ffUL)
/* ========================================================  LGC0LH  ========================================================= */
 #define R_CEC_LGC0LH_LGC0LH_Pos         (0UL)
 #define R_CEC_LGC0LH_LGC0LH_Msk         (0x1ffUL)
/* ========================================================  LGC1LL  ========================================================= */
 #define R_CEC_LGC1LL_LGC1LL_Pos         (0UL)
 #define R_CEC_LGC1LL_LGC1LL_Msk         (0x1ffUL)
/* ========================================================  LGC1LH  ========================================================= */
 #define R_CEC_LGC1LH_LGC1LH_Pos         (0UL)
 #define R_CEC_LGC1LH_LGC1LH_Msk         (0x1ffUL)
/* =========================================================  DATBL  ========================================================= */
 #define R_CEC_DATBL_DATBL_Pos           (0UL)
 #define R_CEC_DATBL_DATBL_Msk           (0x1ffUL)
/* =========================================================  DATBH  ========================================================= */
 #define R_CEC_DATBH_DATBH_Pos           (0UL)
 #define R_CEC_DATBH_DATBH_Msk           (0x1ffUL)
/* =========================================================  NOMP  ========================================================== */
 #define R_CEC_NOMP_NOMP_Pos             (0UL)
 #define R_CEC_NOMP_NOMP_Msk             (0x1ffUL)
/* ========================================================  CECEXMD  ======================================================== */
 #define R_CEC_CECEXMD_LERPLEN_Pos       (4UL)
 #define R_CEC_CECEXMD_LERPLEN_Msk       (0x10UL)
 #define R_CEC_CECEXMD_RERCVEN_Pos       (5UL)
 #define R_CEC_CECEXMD_RERCVEN_Msk       (0x20UL)
 #define R_CEC_CECEXMD_RCVINTDSEL_Pos    (7UL)
 #define R_CEC_CECEXMD_RCVINTDSEL_Msk    (0x80UL)
/* =======================================================  CECEXMON  ======================================================== */
 #define R_CEC_CECEXMON_CECLNMON_Pos     (0UL)
 #define R_CEC_CECEXMON_CECLNMON_Msk     (0x1UL)
 #define R_CEC_CECEXMON_ACKF_Pos         (1UL)
 #define R_CEC_CECEXMON_ACKF_Msk         (0x2UL)
/* =========================================================  CTXD  ========================================================== */
/* =========================================================  CRXD  ========================================================== */
/* =========================================================  CECES  ========================================================= */
 #define R_CEC_CECES_OERR_Pos            (0UL)
 #define R_CEC_CECES_OERR_Msk            (0x1UL)
 #define R_CEC_CECES_UERR_Pos            (1UL)
 #define R_CEC_CECES_UERR_Msk            (0x2UL)
 #define R_CEC_CECES_ACKERR_Pos          (2UL)
 #define R_CEC_CECES_ACKERR_Msk          (0x4UL)
 #define R_CEC_CECES_TERR_Pos            (3UL)
 #define R_CEC_CECES_TERR_Msk            (0x8UL)
 #define R_CEC_CECES_TXERR_Pos           (4UL)
 #define R_CEC_CECES_TXERR_Msk           (0x10UL)
 #define R_CEC_CECES_AERR_Pos            (5UL)
 #define R_CEC_CECES_AERR_Msk            (0x20UL)
 #define R_CEC_CECES_BLERR_Pos           (6UL)
 #define R_CEC_CECES_BLERR_Msk           (0x40UL)
/* =========================================================  CECS  ========================================================== */
 #define R_CEC_CECS_ADRF_Pos             (0UL)
 #define R_CEC_CECS_ADRF_Msk             (0x1UL)
 #define R_CEC_CECS_BUSST_Pos            (1UL)
 #define R_CEC_CECS_BUSST_Msk            (0x2UL)
 #define R_CEC_CECS_TXST_Pos             (2UL)
 #define R_CEC_CECS_TXST_Msk             (0x4UL)
 #define R_CEC_CECS_EOMF_Pos             (3UL)
 #define R_CEC_CECS_EOMF_Msk             (0x8UL)
 #define R_CEC_CECS_ITCEF_Pos            (4UL)
 #define R_CEC_CECS_ITCEF_Msk            (0x10UL)
 #define R_CEC_CECS_SFTST_Pos            (7UL)
 #define R_CEC_CECS_SFTST_Msk            (0x80UL)
/* =========================================================  CECFC  ========================================================= */
 #define R_CEC_CECFC_OCTRG_Pos           (0UL)
 #define R_CEC_CECFC_OCTRG_Msk           (0x1UL)
 #define R_CEC_CECFC_UCTRG_Pos           (1UL)
 #define R_CEC_CECFC_UCTRG_Msk           (0x2UL)
 #define R_CEC_CECFC_ACKCTRG_Pos         (2UL)
 #define R_CEC_CECFC_ACKCTRG_Msk         (0x4UL)
 #define R_CEC_CECFC_TCTRG_Pos           (3UL)
 #define R_CEC_CECFC_TCTRG_Msk           (0x8UL)
 #define R_CEC_CECFC_TXCTRG_Pos          (4UL)
 #define R_CEC_CECFC_TXCTRG_Msk          (0x10UL)
 #define R_CEC_CECFC_ACTRG_Pos           (5UL)
 #define R_CEC_CECFC_ACTRG_Msk           (0x20UL)
 #define R_CEC_CECFC_BLCTRG_Pos          (6UL)
 #define R_CEC_CECFC_BLCTRG_Msk          (0x40UL)
/* ========================================================  CECCTL0  ======================================================== */
 #define R_CEC_CECCTL0_EOM_Pos           (0UL)
 #define R_CEC_CECCTL0_EOM_Msk           (0x1UL)
 #define R_CEC_CECCTL0_CECRXEN_Pos       (1UL)
 #define R_CEC_CECCTL0_CECRXEN_Msk       (0x2UL)
 #define R_CEC_CECCTL0_TXTRG_Pos         (2UL)
 #define R_CEC_CECCTL0_TXTRG_Msk         (0x4UL)
 #define R_CEC_CECCTL0_CCL_Pos           (3UL)
 #define R_CEC_CECCTL0_CCL_Msk           (0x38UL)
 #define R_CEC_CECCTL0_ACKTEN_Pos        (6UL)
 #define R_CEC_CECCTL0_ACKTEN_Msk        (0x40UL)
 #define R_CEC_CECCTL0_CECE_Pos          (7UL)
 #define R_CEC_CECCTL0_CECE_Msk          (0x80UL)
