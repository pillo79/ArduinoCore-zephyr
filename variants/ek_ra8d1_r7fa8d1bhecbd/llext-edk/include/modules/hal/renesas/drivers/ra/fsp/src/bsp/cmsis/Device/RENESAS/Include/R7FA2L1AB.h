...
typedef struct
{
    union
    {
        __IOM uint8_t COMPMDR;

        struct
        {
            __IOM uint8_t C0ENB : 1;
            __IOM uint8_t C0WDE : 1;
            __IOM uint8_t C0VRF : 1;
            __IM uint8_t  C0MON : 1;
            __IOM uint8_t C1ENB : 1;
            __IOM uint8_t C1WDE : 1;
            __IOM uint8_t C1VRF : 1;
            __IM uint8_t  C1MON : 1;
        } COMPMDR_b;
    };

    union
    {
        __IOM uint8_t COMPFIR;

        struct
        {
            __IOM uint8_t C0FCK : 2;
            __IOM uint8_t C0EPO : 1;
            __IOM uint8_t C0EDG : 1;
            __IOM uint8_t C1FCK : 2;
            __IOM uint8_t C1EPO : 1;
            __IOM uint8_t C1EDG : 1;
        } COMPFIR_b;
    };

    union
    {
        __IOM uint8_t COMPOCR;

        struct
        {
            uint8_t             : 1;
            __IOM uint8_t C0OE  : 1;
            __IOM uint8_t C0OP  : 1;
            uint8_t             : 2;
            __IOM uint8_t C1OE  : 1;
            __IOM uint8_t C1OP  : 1;
            __IOM uint8_t SPDMD : 1;
        } COMPOCR_b;
    };
    __IM uint8_t RESERVED;
    ...
    union
    {
        __IOM uint8_t COMPSEL0;

        struct
        {
            __IOM uint8_t IVCMP0 : 3;
            uint8_t              : 1;
            __IOM uint8_t IVCMP1 : 3;
            uint8_t              : 1;
        } COMPSEL0_b;
    };
    ...
    union
    {
        __IOM uint8_t COMPSEL1;

        struct
        {
            __IOM uint8_t IVREF0 : 3;
            uint8_t              : 1;
            __IOM uint8_t IVREF1 : 3;
            __IOM uint8_t C1VRF2 : 1;
        } COMPSEL1_b;
    };
} R_ACMPLP_Type;
...
typedef struct
{
    union
    {
        union
        {
            __IOM uint32_t CTSUCRA;

            struct
            {
                __IOM uint32_t STRT   : 1;
                __IOM uint32_t CAP    : 1;
                __IOM uint32_t SNZ    : 1;
                __IOM uint32_t CFCON  : 1;
                __OM uint32_t  INIT   : 1;
                __IOM uint32_t PUMPON : 1;
                __IOM uint32_t TXVSEL : 2;
                __IOM uint32_t PON    : 1;
                __IOM uint32_t CSW    : 1;
                __IOM uint32_t ATUNE0 : 1;
                __IOM uint32_t ATUNE1 : 1;
                __IOM uint32_t CLK    : 2;
                __IOM uint32_t MD0    : 1;
                __IOM uint32_t MD1    : 1;
                __IOM uint32_t MD2    : 1;
                __IOM uint32_t ATUNE2 : 1;
                __IOM uint32_t LOAD   : 2;
                __IOM uint32_t POSEL  : 2;
                __IOM uint32_t SDPSEL : 1;
                __IOM uint32_t PCSEL  : 1;
                __IOM uint32_t STCLK  : 6;
                __IOM uint32_t DCMODE : 1;
                __IOM uint32_t DCBACK : 1;
            } CTSUCRA_b;
        };
        ...
        struct
        {
            ...
            union
            {
                __IOM uint16_t CTSUCRAH;

                struct
                {
                    __IOM uint8_t CTSUCR2;
                    __IOM uint8_t CTSUCR3;
                };
            };
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUCRB;

            struct
            {
                __IOM uint32_t PRRATIO : 4;
                __IOM uint32_t PRMODE  : 2;
                __IOM uint32_t SOFF    : 1;
                __IOM uint32_t PROFF   : 1;
                __IOM uint32_t SST     : 8;
                uint32_t               : 8;
                __IOM uint32_t SSMOD   : 3;
                uint32_t               : 1;
                __IOM uint32_t SSCNT   : 2;
                uint32_t               : 2;
            } CTSUCRB_b;
        };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUMCH;

            struct
            {
                __IOM uint32_t MCH0 : 6;
                uint32_t            : 2;
                __IOM uint32_t MCH1 : 6;
                uint32_t            : 2;
                __IOM uint32_t MCA0 : 1;
                __IOM uint32_t MCA1 : 1;
                __IOM uint32_t MCA2 : 1;
                __IOM uint32_t MCA3 : 1;
                uint32_t            : 12;
            } CTSUMCH_b;
        };
        ...
        struct
        {
            ...
            union
            {
                __IOM uint16_t CTSUMCHH;
                __IOM uint8_t  CTSUMFAF;
            };
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUCHACA;

            struct
            {
                __IOM uint32_t CHAC00 : 1;
                uint32_t              : 1;
                __IOM uint32_t CHAC02 : 1;
                uint32_t              : 1;
                __IOM uint32_t CHAC04 : 1;
                __IOM uint32_t CHAC05 : 1;
                __IOM uint32_t CHAC06 : 1;
                __IOM uint32_t CHAC07 : 1;
                __IOM uint32_t CHAC08 : 1;
                __IOM uint32_t CHAC09 : 1;
                __IOM uint32_t CHAC10 : 1;
                __IOM uint32_t CHAC11 : 1;
                __IOM uint32_t CHAC12 : 1;
                __IOM uint32_t CHAC13 : 1;
                __IOM uint32_t CHAC14 : 1;
                __IOM uint32_t CHAC15 : 1;
                __IOM uint32_t CHAC16 : 1;
                __IOM uint32_t CHAC17 : 1;
                __IOM uint32_t CHAC18 : 1;
                uint32_t              : 2;
                __IOM uint32_t CHAC21 : 1;
                __IOM uint32_t CHAC22 : 1;
                __IOM uint32_t CHAC23 : 1;
                __IOM uint32_t CHAC24 : 1;
                __IOM uint32_t CHAC25 : 1;
                __IOM uint32_t CHAC26 : 1;
                __IOM uint32_t CHAC27 : 1;
                __IOM uint32_t CHAC28 : 1;
                __IOM uint32_t CHAC29 : 1;
                __IOM uint32_t CHAC30 : 1;
                __IOM uint32_t CHAC31 : 1;
            } CTSUCHACA_b;
        };
        ...
        struct
        {
            union
            {
                __IOM uint16_t CTSUCHACAL;

                struct
                {
                    __IOM uint8_t CTSUCHAC0;
                    __IOM uint8_t CTSUCHAC1;
                };
            };

            union
            {
                __IOM uint16_t CTSUCHACAH;

                struct
                {
                    __IOM uint8_t CTSUCHAC2;
                    __IOM uint8_t CTSUCHAC3;
                };
            };
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUCHACB;

            struct
            {
                __IOM uint32_t CHAC32 : 1;
                __IOM uint32_t CHAC33 : 1;
                __IOM uint32_t CHAC34 : 1;
                __IOM uint32_t CHAC35 : 1;
                uint32_t              : 28;
            } CTSUCHACB_b;
        };
        __IOM uint16_t CTSUCHACBL;
        __IOM uint8_t  CTSUCHAC4;
    };
    ...
    union
    {
        union
        {
            ...
            struct
            {
                __IOM uint32_t CHTRC   : 1;
                uint32_t               : 1;
                __IOM uint32_t CHTRC02 : 1;
                uint32_t               : 1;
                __IOM uint32_t CHTRC04 : 1;
                __IOM uint32_t CHTRC05 : 1;
                __IOM uint32_t CHTRC06 : 1;
                __IOM uint32_t CHTRC07 : 1;
                __IOM uint32_t CHTRC08 : 1;
                __IOM uint32_t CHTRC09 : 1;
                __IOM uint32_t CHTRC10 : 1;
                __IOM uint32_t CHTRC11 : 1;
                __IOM uint32_t CHTRC12 : 1;
                __IOM uint32_t CHTRC13 : 1;
                __IOM uint32_t CHTRC14 : 1;
                __IOM uint32_t CHTRC15 : 1;
                __IOM uint32_t CHTRC16 : 1;
                __IOM uint32_t CHTRC17 : 1;
                __IOM uint32_t CHTRC18 : 1;
                uint32_t               : 2;
                __IOM uint32_t CHTRC21 : 1;
                __IOM uint32_t CHTRC22 : 1;
                __IOM uint32_t CHTRC23 : 1;
                __IOM uint32_t CHTRC24 : 1;
                __IOM uint32_t CHTRC25 : 1;
                __IOM uint32_t CHTRC26 : 1;
                __IOM uint32_t CHTRC27 : 1;
                __IOM uint32_t CHTRC28 : 1;
                __IOM uint32_t CHTRC29 : 1;
                __IOM uint32_t CHTRC30 : 1;
                __IOM uint32_t CHTRC31 : 1;
            } CTSUCHTRCA_b;
        };
    ...
    union
    {
        union
        {
            ...
            struct
            {
                __IOM uint32_t CHTRC32 : 1;
                __IOM uint32_t CHTRC33 : 1;
                __IOM uint32_t CHTRC34 : 1;
                __IOM uint32_t CHTRC35 : 1;
                uint32_t               : 28;
            } CTSUCHTRCB_b;
        };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUSR;

            struct
            {
                __IOM uint32_t MFC     : 2;
                uint32_t               : 3;
                __OM uint32_t ICOMPRST : 1;
                __IM uint32_t ICOMP1   : 1;
                __IM uint32_t ICOMP0   : 1;
                __IM uint32_t STC      : 3;
                uint32_t               : 1;
                __IM uint32_t  DTSR    : 1;
                __IOM uint32_t SENSOVF : 1;
                __IOM uint32_t SUOVF   : 1;
                __IM uint32_t  PS      : 1;
                __IOM uint32_t CFCRDCH : 6;
                uint32_t               : 10;
            } CTSUSR_b;
        };
        ...
        struct
        {
            union
            {
                __IOM uint16_t CTSUSRL;

                struct
                {
                    __IOM uint8_t CTSUSR0;
            ...
            union
            {
                __IOM uint16_t CTSUSRH;
                __IOM uint8_t  CTSUSR2;
            };
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUSO;

            struct
            {
                __IOM uint32_t SO    : 10;
                __IOM uint32_t SNUM  : 8;
                uint32_t             : 2;
                __IOM uint32_t SSDIV : 4;
                __IOM uint32_t SDPA  : 8;
            } CTSUSO_b;
        };
    ...
    union
    {
        union
        {
            __IM uint32_t CTSUSCNT;

            struct
            {
                __IM uint32_t SENSCNT : 16;
                __IM uint32_t SUCKCNT : 16;
            } CTSUSCNT_b;
        };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUCALIB;

            struct
            {
                uint32_t                : 2;
                __IOM uint32_t TSOD     : 1;
                __IOM uint32_t DRV      : 1;
                __IOM uint32_t CLKSEL   : 2;
                __IOM uint32_t SUCLKEN  : 1;
                __IOM uint32_t TSOC     : 1;
                __IOM uint32_t CNTRDSEL : 1;
                __IOM uint32_t IOC      : 1;
                __IOM uint32_t CFCRDMD  : 1;
                __IOM uint32_t DCOFF    : 1;
                uint32_t                : 4;
                __IOM uint32_t CFCSEL   : 6;
                __IOM uint32_t CFCMODE  : 1;
                uint32_t                : 1;
                __IOM uint32_t DACMSEL  : 1;
                __IOM uint32_t DACCARRY : 1;
                ...
                __IOM uint32_t CCOCALIB : 1; /*!< [30..30] Calibration Selection of Current Controlled Oscillator
                                              *   for Measurement                                                           */
                __IOM uint32_t TXREV : 1;
            } CTSUCALIB_b;
        };

        struct
        {
            __IOM uint16_t CTSUDBGR0;
            __IOM uint16_t CTSUDBGR1;
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUSUCLKA;

            struct
            {
                __IOM uint32_t SUADJ0   : 8;
                __IOM uint32_t SUMULTI0 : 8;
                __IOM uint32_t SUADJ1   : 8;
                __IOM uint32_t SUMULTI1 : 8;
            } CTSUSUCLKA_b;
        };

        struct
        {
            __IOM uint16_t CTSUSUCLK0;
            __IOM uint16_t CTSUSUCLK1;
        };
    };
    ...
    union
    {
        union
        {
            __IOM uint32_t CTSUSUCLKB;

            struct
            {
                __IOM uint32_t SUADJ2   : 8;
                __IOM uint32_t SUMULTI2 : 8;
                __IOM uint32_t SUADJ3   : 8;
                __IOM uint32_t SUMULTI3 : 8;
            } CTSUSUCLKB_b;
        };

        struct
        {
            __IOM uint16_t CTSUSUCLK2;
            __IOM uint16_t CTSUSUCLK3;
        };
    };
    ...
    union
    {
        union
        {
            __IM uint32_t CTSUCFCCNT;

            struct
            {
                __IM uint32_t CFCCNT : 16;
                uint32_t             : 16;
            } CTSUCFCCNT_b;
        };
        __IM uint16_t CTSUCFCCNTL;
    };
} R_CTSU2_Type;
...
typedef struct
{
    ...
    union
    {
        __IOM uint16_t FSARL;

        struct
        {
            __IOM uint16_t FSAR15_0 : 16;
        } FSARL_b;
    };
    __IM uint16_t RESERVED8;
    __IM uint32_t RESERVED9;
    ...
    union
    {
        __IOM uint16_t FSARH;

        struct
        {
            __IOM uint16_t FSAR20_16 : 5;
            uint16_t                 : 4;
            __IOM uint16_t FSAR31_25 : 7;
        } FSARH_b;
    };
    ...
    union
    {
        __IOM uint16_t FEARL;

        struct
        {
            __IOM uint16_t FEAR15_0 : 16;
        } FEARL_b;
    };
    __IM uint16_t RESERVED13;
    ...
    union
    {
        __IOM uint32_t FEARH;

        struct
        {
            __IOM uint32_t FEAR20_16 : 5;
            uint32_t                 : 4;
            __IOM uint32_t FEAR31_25 : 7;
            uint32_t                 : 16;
        } FEARH_b;
    };
    ...
    union
    {
        __IOM uint32_t FRESETR;

        struct
        {
            __IOM uint32_t FRESET : 1;
            uint32_t              : 31;
        } FRESETR_b;
    };
    ...
    union
    {
        __IM uint32_t FSTATR00;

        struct
        {
            __IM uint32_t ERERR0   : 1;
            __IM uint32_t PRGERR0  : 1;
            __IM uint32_t PRGERR01 : 1;
            __IM uint32_t BCERR0   : 1;
            __IM uint32_t ILGLERR  : 1;
            __IM uint32_t EILGLERR : 1;
            uint32_t               : 26;
        } FSTATR00_b;
    };
    ...
    union
    {
        __IM uint32_t FSTATR1;

        struct
        {
            uint32_t            : 1;
            __IM uint32_t DRRDY : 1;
            uint32_t            : 4;
            __IM uint32_t FRDY  : 1;
            __IM uint32_t EXRDY : 1;
            uint32_t            : 24;
        } FSTATR1_b;
    };
    ...
    union
    {
        __IOM uint32_t FWBL0;

        struct
        {
            __IOM uint32_t WDATA : 16;
            uint32_t             : 16;
        } FWBL0_b;
    };
    ...
    union
    {
        __IM uint32_t FSTATR01;

        struct
        {
            __IM uint32_t ERERR1  : 1;
            __IM uint32_t PRGERR1 : 1;
            uint32_t              : 1;
            __IM uint32_t BCERR1  : 1;
            uint32_t              : 28;
        } FSTATR01_b;
    };
    ...
    union
    {
        __IOM uint32_t FWBL1;

        struct
        {
            __IOM uint32_t WDATA47_32 : 16;
            uint32_t                  : 16;
        } FWBL1_b;
    };
    ...
    union
    {
        __IOM uint32_t FWBH1;

        struct
        {
            __IOM uint32_t WDATA63_48 : 16;
            uint32_t                  : 16;
        } FWBH1_b;
    };
    ...
    union
    {
        ...
        {
            uint32_t            : 8;
            __IM uint32_t SASMF : 1;
            uint32_t            : 5;
            __IM uint32_t FSPR  : 1;
            uint32_t            : 17;
        } FSCMR_b;
    };
    ...
    union
    {
        __IM uint32_t FAWSMR;

        struct
        {
            __IM uint32_t FAWS : 12;
            uint32_t           : 20;
        } FAWSMR_b;
    };
    ...
    union
    {
        __IM uint32_t FAWEMR;

        struct
        {
            __IM uint32_t FAWE : 12;
            uint32_t           : 20;
        } FAWEMR_b;
    };
    ...
    union
    {
        ...
        struct
        {
            __IOM uint32_t PCKA : 6;
            __IOM uint32_t SAS  : 2;
            uint32_t            : 24;
        } FISR_b;
    };
    ...
    union
    {
        __IM uint32_t FSTATR2;

        struct
        {
            __IM uint32_t  ERERR    : 1;
            __IM uint32_t  PRGERR1  : 1;
            __IOM uint32_t PRGERR01 : 1;
            __IM uint32_t  BCERR    : 1;
            __IM uint32_t  ILGLERR  : 1;
            __IM uint32_t  EILGLERR : 1;
            uint32_t                : 26;
        } FSTATR2_b;
    ...
    union
    {
        __IOM uint8_t HIOTRM;

        struct
        {
            __IOM uint8_t HIOTRM : 6;
            uint8_t              : 2;
        } HIOTRM_b;
    };
    ...
    union
    {
        __IOM uint8_t FLMWRP;

        struct
        {
            __IOM uint8_t FLMWEN : 1;
            uint8_t              : 7;
        } FLMWRP_b;
    };
    ...
    union
    {
        __IOM uint32_t FCTLFR;

        struct
        {
            __IOM uint32_t BANKSWP : 3;
            uint32_t               : 29;
        } FCTLFR_b;
    };
    __IM uint32_t  RESERVED30[3855];
    __IOM uint16_t FENTRYR_MF4;
    __IOM uint16_t FENTRYR;
    __IM uint32_t  RESERVED31[3];
    __IOM uint8_t  FLWAITR;
    __IM uint8_t   RESERVED32;
    __IM uint16_t  RESERVED33;

    union
    {
        __IOM uint8_t FLDWAITR;

        struct
        {
            __IOM uint8_t FLDWAIT1 : 1;
            uint8_t                : 7;
        } FLDWAITR_b;
    };
    ...
    union
    {
        __IOM uint16_t FBKPGCR;

        struct
        {
            __IOM uint16_t BKPGEN : 1;
            uint16_t              : 7;
            __OM uint16_t FEKEY   : 8;
        } FBKPGCR_b;
    };
    ...
    union
    {
        __IOM uint16_t FBKSWCR;

        struct
        {
            __IOM uint16_t BKSWUPEN : 1;
            uint16_t                : 7;
            __OM uint16_t FEKEY     : 8;
        } FBKSWCR_b;
    };
...
typedef struct
{
    ...
    union
    {
        __IOM uint32_t CTSUTRIMA;

        struct
        {
            __IOM uint32_t RTRIM     : 8;
            __IOM uint32_t DACTRIM   : 8;
            __IOM uint32_t SUADJD    : 8;
...
typedef struct
{
    ...
    union
    {
        __IOM uint8_t TRNGSCR0;

        struct
        {
            uint8_t               : 2;
            __OM uint8_t  SGSTART : 1;
            __IOM uint8_t SGCEN   : 1;
            uint8_t               : 3;
    ...
    union
    {
        __IOM uint8_t TRNGSCR1;

        struct
        {
            __IOM uint8_t INTEN : 1;
            uint8_t             : 7;
        } TRNGSCR1_b;
    };
} R_TRNG_Type;
...
typedef struct
{
    union
    {
        __IOM uint16_t AESMOD;

        struct
        {
            __IOM uint16_t MODEN  : 1;
            uint16_t              : 7;
            __IOM uint16_t RDRQEN : 1;
            __IOM uint16_t WRRQEN : 1;
            uint16_t              : 6;
        } AESMOD_b;
    };
    __IM uint16_t RESERVED;
    ...
    union
    {
        __IOM uint32_t AESCMD;

        struct
        {
            __IOM uint32_t INVCIP   : 1;
            __IOM uint32_t KEYLN    : 1;
            uint32_t                : 2;
            __IOM uint32_t CHAIN    : 2;
            uint32_t                : 2;
            __IOM uint32_t STORESEL : 2;
            uint32_t                : 2;
            __IOM uint32_t KEYSEL   : 1;
            uint32_t                : 11;
    ...
    __IOM uint32_t AESDW;
    __IOM uint32_t AESIVW;
    __IOM uint32_t AESKW0;
    __IOM uint32_t AESKW1;
} R_AES_Type;
...
/* ========================================================  COMPMDR  ======================================================== */
 #define R_ACMPLP_COMPMDR_C1MON_Pos      (7UL)
 #define R_ACMPLP_COMPMDR_C1MON_Msk      (0x80UL)
 #define R_ACMPLP_COMPMDR_C1VRF_Pos      (6UL)
 #define R_ACMPLP_COMPMDR_C1VRF_Msk      (0x40UL)
 #define R_ACMPLP_COMPMDR_C1WDE_Pos      (5UL)
 #define R_ACMPLP_COMPMDR_C1WDE_Msk      (0x20UL)
 #define R_ACMPLP_COMPMDR_C1ENB_Pos      (4UL)
 #define R_ACMPLP_COMPMDR_C1ENB_Msk      (0x10UL)
 #define R_ACMPLP_COMPMDR_C0MON_Pos      (3UL)
 #define R_ACMPLP_COMPMDR_C0MON_Msk      (0x8UL)
 #define R_ACMPLP_COMPMDR_C0WDE_Pos      (1UL)
 #define R_ACMPLP_COMPMDR_C0WDE_Msk      (0x2UL)
 #define R_ACMPLP_COMPMDR_C0VRF_Pos      (2UL)
 #define R_ACMPLP_COMPMDR_C0VRF_Msk      (0x4UL)
 #define R_ACMPLP_COMPMDR_C0ENB_Pos      (0UL)
 #define R_ACMPLP_COMPMDR_C0ENB_Msk      (0x1UL)
/* ========================================================  COMPFIR  ======================================================== */
 #define R_ACMPLP_COMPFIR_C1EDG_Pos      (7UL)
 #define R_ACMPLP_COMPFIR_C1EDG_Msk      (0x80UL)
 #define R_ACMPLP_COMPFIR_C1EPO_Pos      (6UL)
 #define R_ACMPLP_COMPFIR_C1EPO_Msk      (0x40UL)
 #define R_ACMPLP_COMPFIR_C1FCK_Pos      (4UL)
 #define R_ACMPLP_COMPFIR_C1FCK_Msk      (0x30UL)
 #define R_ACMPLP_COMPFIR_C0EDG_Pos      (3UL)
 #define R_ACMPLP_COMPFIR_C0EDG_Msk      (0x8UL)
 #define R_ACMPLP_COMPFIR_C0EPO_Pos      (2UL)
 #define R_ACMPLP_COMPFIR_C0EPO_Msk      (0x4UL)
 #define R_ACMPLP_COMPFIR_C0FCK_Pos      (0UL)
 #define R_ACMPLP_COMPFIR_C0FCK_Msk      (0x3UL)
/* ========================================================  COMPOCR  ======================================================== */
 #define R_ACMPLP_COMPOCR_SPDMD_Pos      (7UL)
 #define R_ACMPLP_COMPOCR_SPDMD_Msk      (0x80UL)
 #define R_ACMPLP_COMPOCR_C1OP_Pos       (6UL)
 #define R_ACMPLP_COMPOCR_C1OP_Msk       (0x40UL)
 #define R_ACMPLP_COMPOCR_C1OE_Pos       (5UL)
 #define R_ACMPLP_COMPOCR_C1OE_Msk       (0x20UL)
 #define R_ACMPLP_COMPOCR_C0OP_Pos       (2UL)
 #define R_ACMPLP_COMPOCR_C0OP_Msk       (0x4UL)
 #define R_ACMPLP_COMPOCR_C0OE_Pos       (1UL)
 #define R_ACMPLP_COMPOCR_C0OE_Msk       (0x2UL)
/* =======================================================  COMPSEL0  ======================================================== */
 #define R_ACMPLP_COMPSEL0_IVCMP1_Pos    (4UL)
 #define R_ACMPLP_COMPSEL0_IVCMP1_Msk    (0x70UL)
 #define R_ACMPLP_COMPSEL0_IVCMP0_Pos    (0UL)
 #define R_ACMPLP_COMPSEL0_IVCMP0_Msk    (0x7UL)
/* =======================================================  COMPSEL1  ======================================================== */
 #define R_ACMPLP_COMPSEL1_C1VRF2_Pos    (7UL)
 #define R_ACMPLP_COMPSEL1_C1VRF2_Msk    (0x80UL)
 #define R_ACMPLP_COMPSEL1_IVREF1_Pos    (4UL)
 #define R_ACMPLP_COMPSEL1_IVREF1_Msk    (0x70UL)
 #define R_ACMPLP_COMPSEL1_IVREF0_Pos    (0UL)
 #define R_ACMPLP_COMPSEL1_IVREF0_Msk    (0x7UL)
...
/* ========================================================  CTSUCRA  ======================================================== */
 #define R_CTSU2_CTSUCRA_STRT_Pos      (0UL)
 #define R_CTSU2_CTSUCRA_STRT_Msk      (0x1UL)
 #define R_CTSU2_CTSUCRA_CAP_Pos       (1UL)
 #define R_CTSU2_CTSUCRA_CAP_Msk       (0x2UL)
 #define R_CTSU2_CTSUCRA_SNZ_Pos       (2UL)
 #define R_CTSU2_CTSUCRA_SNZ_Msk       (0x4UL)
 #define R_CTSU2_CTSUCRA_CFCON_Pos     (3UL)
 #define R_CTSU2_CTSUCRA_CFCON_Msk     (0x8UL)
 #define R_CTSU2_CTSUCRA_INIT_Pos      (4UL)
 #define R_CTSU2_CTSUCRA_INIT_Msk      (0x10UL)
 #define R_CTSU2_CTSUCRA_PUMPON_Pos    (5UL)
 #define R_CTSU2_CTSUCRA_PUMPON_Msk    (0x20UL)
 #define R_CTSU2_CTSUCRA_TXVSEL_Pos    (6UL)
 #define R_CTSU2_CTSUCRA_TXVSEL_Msk    (0xc0UL)
 #define R_CTSU2_CTSUCRA_PON_Pos       (8UL)
 #define R_CTSU2_CTSUCRA_PON_Msk       (0x100UL)
 #define R_CTSU2_CTSUCRA_CSW_Pos       (9UL)
 #define R_CTSU2_CTSUCRA_CSW_Msk       (0x200UL)
 #define R_CTSU2_CTSUCRA_ATUNE0_Pos    (10UL)
 #define R_CTSU2_CTSUCRA_ATUNE0_Msk    (0x400UL)
 #define R_CTSU2_CTSUCRA_ATUNE1_Pos    (11UL)
 #define R_CTSU2_CTSUCRA_ATUNE1_Msk    (0x800UL)
 #define R_CTSU2_CTSUCRA_CLK_Pos       (12UL)
 #define R_CTSU2_CTSUCRA_CLK_Msk       (0x3000UL)
 #define R_CTSU2_CTSUCRA_MD0_Pos       (14UL)
 #define R_CTSU2_CTSUCRA_MD0_Msk       (0x4000UL)
 #define R_CTSU2_CTSUCRA_MD1_Pos       (15UL)
 #define R_CTSU2_CTSUCRA_MD1_Msk       (0x8000UL)
 #define R_CTSU2_CTSUCRA_MD2_Pos       (16UL)
 #define R_CTSU2_CTSUCRA_MD2_Msk       (0x10000UL)
 #define R_CTSU2_CTSUCRA_ATUNE2_Pos    (17UL)
 #define R_CTSU2_CTSUCRA_ATUNE2_Msk    (0x20000UL)
 #define R_CTSU2_CTSUCRA_LOAD_Pos      (18UL)
 #define R_CTSU2_CTSUCRA_LOAD_Msk      (0xc0000UL)
 #define R_CTSU2_CTSUCRA_POSEL_Pos     (20UL)
 #define R_CTSU2_CTSUCRA_POSEL_Msk     (0x300000UL)
 #define R_CTSU2_CTSUCRA_SDPSEL_Pos    (22UL)
 #define R_CTSU2_CTSUCRA_SDPSEL_Msk    (0x400000UL)
 #define R_CTSU2_CTSUCRA_PCSEL_Pos     (23UL)
 #define R_CTSU2_CTSUCRA_PCSEL_Msk     (0x800000UL)
 #define R_CTSU2_CTSUCRA_STCLK_Pos     (24UL)
 #define R_CTSU2_CTSUCRA_STCLK_Msk     (0x3f000000UL)
 #define R_CTSU2_CTSUCRA_DCMODE_Pos    (30UL)
 #define R_CTSU2_CTSUCRA_DCMODE_Msk    (0x40000000UL)
 #define R_CTSU2_CTSUCRA_DCBACK_Pos    (31UL)
 #define R_CTSU2_CTSUCRA_DCBACK_Msk    (0x80000000UL)
/* =======================================================  CTSUCRAL  ======================================================== */
/* ========================================================  CTSUCR0  ======================================================== */
/* ========================================================  CTSUCR1  ======================================================== */
/* =======================================================  CTSUCRAH  ======================================================== */
...
/* ========================================================  CTSUCR3  ======================================================== */
/* ========================================================  CTSUCRB  ======================================================== */
 #define R_CTSU2_CTSUCRB_PRRATIO_Pos    (0UL)
 #define R_CTSU2_CTSUCRB_PRRATIO_Msk    (0xfUL)
 #define R_CTSU2_CTSUCRB_PRMODE_Pos     (4UL)
 #define R_CTSU2_CTSUCRB_PRMODE_Msk     (0x30UL)
 #define R_CTSU2_CTSUCRB_SOFF_Pos       (6UL)
 #define R_CTSU2_CTSUCRB_SOFF_Msk       (0x40UL)
 #define R_CTSU2_CTSUCRB_PROFF_Pos      (7UL)
 #define R_CTSU2_CTSUCRB_PROFF_Msk      (0x80UL)
 #define R_CTSU2_CTSUCRB_SST_Pos        (8UL)
 #define R_CTSU2_CTSUCRB_SST_Msk        (0xff00UL)
 #define R_CTSU2_CTSUCRB_SSMOD_Pos      (24UL)
 #define R_CTSU2_CTSUCRB_SSMOD_Msk      (0x7000000UL)
 #define R_CTSU2_CTSUCRB_SSCNT_Pos      (28UL)
 #define R_CTSU2_CTSUCRB_SSCNT_Msk      (0x30000000UL)
/* =======================================================  CTSUCRBL  ======================================================== */
/* =======================================================  CTSUSDPRS  ======================================================= */
/* ========================================================  CTSUSST  ======================================================== */
/* =======================================================  CTSUCRBH  ======================================================== */
/* =======================================================  CTSUDCLKC  ======================================================= */
/* ========================================================  CTSUMCH  ======================================================== */
 #define R_CTSU2_CTSUMCH_MCH0_Pos    (0UL)
 #define R_CTSU2_CTSUMCH_MCH0_Msk    (0x3fUL)
 #define R_CTSU2_CTSUMCH_MCH1_Pos    (8UL)
 #define R_CTSU2_CTSUMCH_MCH1_Msk    (0x3f00UL)
 #define R_CTSU2_CTSUMCH_MCA0_Pos    (16UL)
 #define R_CTSU2_CTSUMCH_MCA0_Msk    (0x10000UL)
 #define R_CTSU2_CTSUMCH_MCA1_Pos    (17UL)
 #define R_CTSU2_CTSUMCH_MCA1_Msk    (0x20000UL)
 #define R_CTSU2_CTSUMCH_MCA2_Pos    (18UL)
 #define R_CTSU2_CTSUMCH_MCA2_Msk    (0x40000UL)
 #define R_CTSU2_CTSUMCH_MCA3_Pos    (19UL)
 #define R_CTSU2_CTSUMCH_MCA3_Msk    (0x80000UL)
/* =======================================================  CTSUMCHL  ======================================================== */
/* =======================================================  CTSUMCH0  ======================================================== */
/* =======================================================  CTSUMCH1  ======================================================== */
/* =======================================================  CTSUMCHH  ======================================================== */
/* =======================================================  CTSUMFAF  ======================================================== */
/* =======================================================  CTSUCHACA  ======================================================= */
 #define R_CTSU2_CTSUCHACA_CHAC00_Pos    (0UL)
 #define R_CTSU2_CTSUCHACA_CHAC00_Msk    (0x1UL)
 #define R_CTSU2_CTSUCHACA_CHAC02_Pos    (2UL)
 #define R_CTSU2_CTSUCHACA_CHAC02_Msk    (0x4UL)
 #define R_CTSU2_CTSUCHACA_CHAC04_Pos    (4UL)
 #define R_CTSU2_CTSUCHACA_CHAC04_Msk    (0x10UL)
 #define R_CTSU2_CTSUCHACA_CHAC05_Pos    (5UL)
 #define R_CTSU2_CTSUCHACA_CHAC05_Msk    (0x20UL)
 #define R_CTSU2_CTSUCHACA_CHAC06_Pos    (6UL)
 #define R_CTSU2_CTSUCHACA_CHAC06_Msk    (0x40UL)
 #define R_CTSU2_CTSUCHACA_CHAC07_Pos    (7UL)
 #define R_CTSU2_CTSUCHACA_CHAC07_Msk    (0x80UL)
 #define R_CTSU2_CTSUCHACA_CHAC08_Pos    (8UL)
 #define R_CTSU2_CTSUCHACA_CHAC08_Msk    (0x100UL)
 #define R_CTSU2_CTSUCHACA_CHAC09_Pos    (9UL)
 #define R_CTSU2_CTSUCHACA_CHAC09_Msk    (0x200UL)
 #define R_CTSU2_CTSUCHACA_CHAC10_Pos    (10UL)
 #define R_CTSU2_CTSUCHACA_CHAC10_Msk    (0x400UL)
 #define R_CTSU2_CTSUCHACA_CHAC11_Pos    (11UL)
 #define R_CTSU2_CTSUCHACA_CHAC11_Msk    (0x800UL)
 #define R_CTSU2_CTSUCHACA_CHAC12_Pos    (12UL)
 #define R_CTSU2_CTSUCHACA_CHAC12_Msk    (0x1000UL)
 #define R_CTSU2_CTSUCHACA_CHAC13_Pos    (13UL)
 #define R_CTSU2_CTSUCHACA_CHAC13_Msk    (0x2000UL)
 #define R_CTSU2_CTSUCHACA_CHAC14_Pos    (14UL)
 #define R_CTSU2_CTSUCHACA_CHAC14_Msk    (0x4000UL)
 #define R_CTSU2_CTSUCHACA_CHAC15_Pos    (15UL)
 #define R_CTSU2_CTSUCHACA_CHAC15_Msk    (0x8000UL)
 #define R_CTSU2_CTSUCHACA_CHAC16_Pos    (16UL)
 #define R_CTSU2_CTSUCHACA_CHAC16_Msk    (0x10000UL)
 #define R_CTSU2_CTSUCHACA_CHAC17_Pos    (17UL)
 #define R_CTSU2_CTSUCHACA_CHAC17_Msk    (0x20000UL)
 #define R_CTSU2_CTSUCHACA_CHAC18_Pos    (18UL)
 #define R_CTSU2_CTSUCHACA_CHAC18_Msk    (0x40000UL)
 #define R_CTSU2_CTSUCHACA_CHAC21_Pos    (21UL)
 #define R_CTSU2_CTSUCHACA_CHAC21_Msk    (0x200000UL)
 #define R_CTSU2_CTSUCHACA_CHAC22_Pos    (22UL)
 #define R_CTSU2_CTSUCHACA_CHAC22_Msk    (0x400000UL)
 #define R_CTSU2_CTSUCHACA_CHAC23_Pos    (23UL)
 #define R_CTSU2_CTSUCHACA_CHAC23_Msk    (0x800000UL)
 #define R_CTSU2_CTSUCHACA_CHAC24_Pos    (24UL)
 #define R_CTSU2_CTSUCHACA_CHAC24_Msk    (0x1000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC25_Pos    (25UL)
 #define R_CTSU2_CTSUCHACA_CHAC25_Msk    (0x2000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC26_Pos    (26UL)
 #define R_CTSU2_CTSUCHACA_CHAC26_Msk    (0x4000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC27_Pos    (27UL)
 #define R_CTSU2_CTSUCHACA_CHAC27_Msk    (0x8000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC28_Pos    (28UL)
 #define R_CTSU2_CTSUCHACA_CHAC28_Msk    (0x10000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC29_Pos    (29UL)
 #define R_CTSU2_CTSUCHACA_CHAC29_Msk    (0x20000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC30_Pos    (30UL)
 #define R_CTSU2_CTSUCHACA_CHAC30_Msk    (0x40000000UL)
 #define R_CTSU2_CTSUCHACA_CHAC31_Pos    (31UL)
 #define R_CTSU2_CTSUCHACA_CHAC31_Msk    (0x80000000UL)
/* ======================================================  CTSUCHACAL  ======================================================= */
/* =======================================================  CTSUCHAC0  ======================================================= */
/* =======================================================  CTSUCHAC1  ======================================================= */
/* ======================================================  CTSUCHACAH  ======================================================= */
...
/* =======================================================  CTSUCHAC3  ======================================================= */
/* =======================================================  CTSUCHACB  ======================================================= */
 #define R_CTSU2_CTSUCHACB_CHAC32_Pos      (0UL)
 #define R_CTSU2_CTSUCHACB_CHAC32_Msk      (0x1UL)
 #define R_CTSU2_CTSUCHACB_CHAC33_Pos      (1UL)
 #define R_CTSU2_CTSUCHACB_CHAC33_Msk      (0x2UL)
 #define R_CTSU2_CTSUCHACB_CHAC34_Pos      (2UL)
 #define R_CTSU2_CTSUCHACB_CHAC34_Msk      (0x4UL)
 #define R_CTSU2_CTSUCHACB_CHAC35_Pos      (3UL)
 #define R_CTSU2_CTSUCHACB_CHAC35_Msk      (0x8UL)
/* ======================================================  CTSUCHACBL  ======================================================= */
/* =======================================================  CTSUCHAC4  ======================================================= */
/* ======================================================  CTSUCHTRCA  ======================================================= */
 #define R_CTSU2_CTSUCHTRCA_CHTRC_Pos      (0UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC_Msk      (0x1UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC02_Pos    (2UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC02_Msk    (0x4UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC04_Pos    (4UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC04_Msk    (0x10UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC05_Pos    (5UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC05_Msk    (0x20UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC06_Pos    (6UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC06_Msk    (0x40UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC07_Pos    (7UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC07_Msk    (0x80UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC08_Pos    (8UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC08_Msk    (0x100UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC09_Pos    (9UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC09_Msk    (0x200UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC10_Pos    (10UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC10_Msk    (0x400UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC11_Pos    (11UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC11_Msk    (0x800UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC12_Pos    (12UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC12_Msk    (0x1000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC13_Pos    (13UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC13_Msk    (0x2000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC14_Pos    (14UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC14_Msk    (0x4000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC15_Pos    (15UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC15_Msk    (0x8000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC16_Pos    (16UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC16_Msk    (0x10000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC17_Pos    (17UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC17_Msk    (0x20000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC18_Pos    (18UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC18_Msk    (0x40000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC21_Pos    (21UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC21_Msk    (0x200000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC22_Pos    (22UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC22_Msk    (0x400000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC23_Pos    (23UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC23_Msk    (0x800000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC24_Pos    (24UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC24_Msk    (0x1000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC25_Pos    (25UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC25_Msk    (0x2000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC26_Pos    (26UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC26_Msk    (0x4000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC27_Pos    (27UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC27_Msk    (0x8000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC28_Pos    (28UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC28_Msk    (0x10000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC29_Pos    (29UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC29_Msk    (0x20000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC30_Pos    (30UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC30_Msk    (0x40000000UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC31_Pos    (31UL)
 #define R_CTSU2_CTSUCHTRCA_CHTRC31_Msk    (0x80000000UL)
/* ======================================================  CTSUCHTRCAL  ====================================================== */
/* ======================================================  CTSUCHTRC0  ======================================================= */
/* ======================================================  CTSUCHTRC1  ======================================================= */
/* ======================================================  CTSUCHTRCAH  ====================================================== */
...
/* ======================================================  CTSUCHTRC3  ======================================================= */
/* ======================================================  CTSUCHTRCB  ======================================================= */
 #define R_CTSU2_CTSUCHTRCB_CHTRC32_Pos    (0UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC32_Msk    (0x1UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC33_Pos    (1UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC33_Msk    (0x2UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC34_Pos    (2UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC34_Msk    (0x4UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC35_Pos    (3UL)
 #define R_CTSU2_CTSUCHTRCB_CHTRC35_Msk    (0x8UL)
/* ======================================================  CTSUCHTRCBL  ====================================================== */
/* ======================================================  CTSUCHTRC4  ======================================================= */
/* ========================================================  CTSUSR  ========================================================= */
 #define R_CTSU2_CTSUSR_MFC_Pos            (0UL)
 #define R_CTSU2_CTSUSR_MFC_Msk            (0x3UL)
 #define R_CTSU2_CTSUSR_ICOMPRST_Pos       (5UL)
 #define R_CTSU2_CTSUSR_ICOMPRST_Msk       (0x20UL)
 #define R_CTSU2_CTSUSR_ICOMP1_Pos         (6UL)
 #define R_CTSU2_CTSUSR_ICOMP1_Msk         (0x40UL)
 #define R_CTSU2_CTSUSR_ICOMP0_Pos         (7UL)
 #define R_CTSU2_CTSUSR_ICOMP0_Msk         (0x80UL)
 #define R_CTSU2_CTSUSR_STC_Pos            (8UL)
 #define R_CTSU2_CTSUSR_STC_Msk            (0x700UL)
 #define R_CTSU2_CTSUSR_DTSR_Pos           (12UL)
 #define R_CTSU2_CTSUSR_DTSR_Msk           (0x1000UL)
 #define R_CTSU2_CTSUSR_SENSOVF_Pos        (13UL)
 #define R_CTSU2_CTSUSR_SENSOVF_Msk        (0x2000UL)
 #define R_CTSU2_CTSUSR_SUOVF_Pos          (14UL)
 #define R_CTSU2_CTSUSR_SUOVF_Msk          (0x4000UL)
 #define R_CTSU2_CTSUSR_PS_Pos             (15UL)
 #define R_CTSU2_CTSUSR_PS_Msk             (0x8000UL)
 #define R_CTSU2_CTSUSR_CFCRDCH_Pos        (16UL)
 #define R_CTSU2_CTSUSR_CFCRDCH_Msk        (0x3f0000UL)
/* ========================================================  CTSUSRL  ======================================================== */
/* ========================================================  CTSUSR0  ======================================================== */
/* ========================================================  CTSUST  ========================================================= */
/* ========================================================  CTSUSRH  ======================================================== */
/* ========================================================  CTSUSR2  ======================================================== */
/* ========================================================  CTSUSO  ========================================================= */
 #define R_CTSU2_CTSUSO_SO_Pos              (0UL)
 #define R_CTSU2_CTSUSO_SO_Msk              (0x3ffUL)
 #define R_CTSU2_CTSUSO_SNUM_Pos            (10UL)
 #define R_CTSU2_CTSUSO_SNUM_Msk            (0x3fc00UL)
 #define R_CTSU2_CTSUSO_SSDIV_Pos           (20UL)
 #define R_CTSU2_CTSUSO_SSDIV_Msk           (0xf00000UL)
 #define R_CTSU2_CTSUSO_SDPA_Pos            (24UL)
 #define R_CTSU2_CTSUSO_SDPA_Msk            (0xff000000UL)
/* ========================================================  CTSUSO0  ======================================================== */
/* ========================================================  CTSUSO1  ======================================================== */
/* =======================================================  CTSUSCNT  ======================================================== */
 #define R_CTSU2_CTSUSCNT_SENSCNT_Pos       (0UL)
 #define R_CTSU2_CTSUSCNT_SENSCNT_Msk       (0xffffUL)
 #define R_CTSU2_CTSUSCNT_SUCKCNT_Pos       (16UL)
 #define R_CTSU2_CTSUSCNT_SUCKCNT_Msk       (0xffff0000UL)
/* ========================================================  CTSUSC  ========================================================= */
/* =======================================================  CTSUCALIB  ======================================================= */
 #define R_CTSU2_CTSUCALIB_TSOD_Pos         (2UL)
 #define R_CTSU2_CTSUCALIB_TSOD_Msk         (0x4UL)
 #define R_CTSU2_CTSUCALIB_DRV_Pos          (3UL)
 #define R_CTSU2_CTSUCALIB_DRV_Msk          (0x8UL)
 #define R_CTSU2_CTSUCALIB_CLKSEL_Pos       (4UL)
 #define R_CTSU2_CTSUCALIB_CLKSEL_Msk       (0x30UL)
 #define R_CTSU2_CTSUCALIB_SUCLKEN_Pos      (6UL)
 #define R_CTSU2_CTSUCALIB_SUCLKEN_Msk      (0x40UL)
 #define R_CTSU2_CTSUCALIB_TSOC_Pos         (7UL)
 #define R_CTSU2_CTSUCALIB_TSOC_Msk         (0x80UL)
 #define R_CTSU2_CTSUCALIB_CNTRDSEL_Pos     (8UL)
 #define R_CTSU2_CTSUCALIB_CNTRDSEL_Msk     (0x100UL)
 #define R_CTSU2_CTSUCALIB_IOC_Pos          (9UL)
 #define R_CTSU2_CTSUCALIB_IOC_Msk          (0x200UL)
 #define R_CTSU2_CTSUCALIB_CFCRDMD_Pos      (10UL)
 #define R_CTSU2_CTSUCALIB_CFCRDMD_Msk      (0x400UL)
 #define R_CTSU2_CTSUCALIB_DCOFF_Pos        (11UL)
 #define R_CTSU2_CTSUCALIB_DCOFF_Msk        (0x800UL)
 #define R_CTSU2_CTSUCALIB_CFCSEL_Pos       (16UL)
 #define R_CTSU2_CTSUCALIB_CFCSEL_Msk       (0x3f0000UL)
 #define R_CTSU2_CTSUCALIB_CFCMODE_Pos      (22UL)
 #define R_CTSU2_CTSUCALIB_CFCMODE_Msk      (0x400000UL)
 #define R_CTSU2_CTSUCALIB_DACMSEL_Pos      (24UL)
 #define R_CTSU2_CTSUCALIB_DACMSEL_Msk      (0x1000000UL)
 #define R_CTSU2_CTSUCALIB_DACCARRY_Pos     (25UL)
 #define R_CTSU2_CTSUCALIB_DACCARRY_Msk     (0x2000000UL)
 #define R_CTSU2_CTSUCALIB_SUMSEL_Pos       (26UL)
 #define R_CTSU2_CTSUCALIB_SUMSEL_Msk       (0x4000000UL)
 #define R_CTSU2_CTSUCALIB_SUCARRY_Pos      (27UL)
 #define R_CTSU2_CTSUCALIB_SUCARRY_Msk      (0x8000000UL)
 #define R_CTSU2_CTSUCALIB_DACCLK_Pos       (28UL)
 #define R_CTSU2_CTSUCALIB_DACCLK_Msk       (0x10000000UL)
 #define R_CTSU2_CTSUCALIB_CCOCLK_Pos       (29UL)
 #define R_CTSU2_CTSUCALIB_CCOCLK_Msk       (0x20000000UL)
 #define R_CTSU2_CTSUCALIB_CCOCALIB_Pos     (30UL)
 #define R_CTSU2_CTSUCALIB_CCOCALIB_Msk     (0x40000000UL)
 #define R_CTSU2_CTSUCALIB_TXREV_Pos        (31UL)
 #define R_CTSU2_CTSUCALIB_TXREV_Msk        (0x80000000UL)
/* =======================================================  CTSUDBGR0  ======================================================= */
/* =======================================================  CTSUDBGR1  ======================================================= */
/* ======================================================  CTSUSUCLKA  ======================================================= */
 #define R_CTSU2_CTSUSUCLKA_SUADJ0_Pos      (0UL)
 #define R_CTSU2_CTSUSUCLKA_SUADJ0_Msk      (0xffUL)
 #define R_CTSU2_CTSUSUCLKA_SUMULTI0_Pos    (8UL)
 #define R_CTSU2_CTSUSUCLKA_SUMULTI0_Msk    (0xff00UL)
 #define R_CTSU2_CTSUSUCLKA_SUADJ1_Pos      (16UL)
 #define R_CTSU2_CTSUSUCLKA_SUADJ1_Msk      (0xff0000UL)
 #define R_CTSU2_CTSUSUCLKA_SUMULTI1_Pos    (24UL)
 #define R_CTSU2_CTSUSUCLKA_SUMULTI1_Msk    (0xff000000UL)
/* ======================================================  CTSUSUCLK0  ======================================================= */
/* ======================================================  CTSUSUCLK1  ======================================================= */
/* ======================================================  CTSUSUCLKB  ======================================================= */
 #define R_CTSU2_CTSUSUCLKB_SUADJ2_Pos      (0UL)
 #define R_CTSU2_CTSUSUCLKB_SUADJ2_Msk      (0xffUL)
 #define R_CTSU2_CTSUSUCLKB_SUMULTI2_Pos    (8UL)
 #define R_CTSU2_CTSUSUCLKB_SUMULTI2_Msk    (0xff00UL)
 #define R_CTSU2_CTSUSUCLKB_SUADJ3_Pos      (16UL)
 #define R_CTSU2_CTSUSUCLKB_SUADJ3_Msk      (0xff0000UL)
 #define R_CTSU2_CTSUSUCLKB_SUMULTI3_Pos    (24UL)
 #define R_CTSU2_CTSUSUCLKB_SUMULTI3_Msk    (0xff000000UL)
/* ======================================================  CTSUSUCLK2  ======================================================= */
/* ======================================================  CTSUSUCLK3  ======================================================= */
/* ======================================================  CTSUCFCCNT  ======================================================= */
 #define R_CTSU2_CTSUCFCCNT_CFCCNT_Pos      (0UL)
 #define R_CTSU2_CTSUCFCCNT_CFCCNT_Msk      (0xffffUL)
/* ======================================================  CTSUCFCCNTL  ====================================================== */
...
/* ========================================================  DFLCTL  ========================================================= */
/* =========================================================  FPMCR  ========================================================= */
 #define R_FACI_LP_FPMCR_FMS2_Pos           (7UL)
 #define R_FACI_LP_FPMCR_FMS2_Msk           (0x80UL)
 #define R_FACI_LP_FPMCR_VLPE_Pos           (6UL)
 #define R_FACI_LP_FPMCR_VLPE_Msk           (0x40UL)
 #define R_FACI_LP_FPMCR_FMS1_Pos           (4UL)
 #define R_FACI_LP_FPMCR_FMS1_Msk           (0x10UL)
 #define R_FACI_LP_FPMCR_RPDIS_Pos          (3UL)
 #define R_FACI_LP_FPMCR_RPDIS_Msk          (0x8UL)
 #define R_FACI_LP_FPMCR_FMS0_Pos           (1UL)
 #define R_FACI_LP_FPMCR_FMS0_Msk           (0x2UL)
/* =========================================================  FASR  ========================================================== */
 #define R_FACI_LP_FASR_EXS_Pos             (0UL)
 #define R_FACI_LP_FASR_EXS_Msk             (0x1UL)
/* =========================================================  FSARL  ========================================================= */
 #define R_FACI_LP_FSARL_FSAR15_0_Pos       (0UL)
 #define R_FACI_LP_FSARL_FSAR15_0_Msk       (0xffffUL)
/* =========================================================  FSARH  ========================================================= */
 #define R_FACI_LP_FSARH_FSAR31_25_Pos      (9UL)
 #define R_FACI_LP_FSARH_FSAR31_25_Msk      (0xfe00UL)
 #define R_FACI_LP_FSARH_FSAR20_16_Pos      (0UL)
 #define R_FACI_LP_FSARH_FSAR20_16_Msk      (0x1fUL)
/* ==========================================================  FCR  ========================================================== */
 #define R_FACI_LP_FCR_OPST_Pos             (7UL)
 #define R_FACI_LP_FCR_OPST_Msk             (0x80UL)
 #define R_FACI_LP_FCR_STOP_Pos             (6UL)
 #define R_FACI_LP_FCR_STOP_Msk             (0x40UL)
 #define R_FACI_LP_FCR_DRC_Pos              (4UL)
 #define R_FACI_LP_FCR_DRC_Msk              (0x10UL)
 #define R_FACI_LP_FCR_CMD_Pos              (0UL)
 #define R_FACI_LP_FCR_CMD_Msk              (0xfUL)
/* =========================================================  FEARL  ========================================================= */
 #define R_FACI_LP_FEARL_FEAR15_0_Pos       (0UL)
 #define R_FACI_LP_FEARL_FEAR15_0_Msk       (0xffffUL)
/* =========================================================  FEARH  ========================================================= */
 #define R_FACI_LP_FEARH_FEAR31_25_Pos      (9UL)
 #define R_FACI_LP_FEARH_FEAR31_25_Msk      (0xfe00UL)
 #define R_FACI_LP_FEARH_FEAR20_16_Pos      (0UL)
 #define R_FACI_LP_FEARH_FEAR20_16_Msk      (0x1fUL)
/* ========================================================  FRESETR  ======================================================== */
 #define R_FACI_LP_FRESETR_FRESET_Pos       (0UL)
 #define R_FACI_LP_FRESETR_FRESET_Msk       (0x1UL)
/* =======================================================  FSTATR00  ======================================================== */
 #define R_FACI_LP_FSTATR00_EILGLERR_Pos    (5UL)
 #define R_FACI_LP_FSTATR00_EILGLERR_Msk    (0x20UL)
 #define R_FACI_LP_FSTATR00_ILGLERR_Pos     (4UL)
 #define R_FACI_LP_FSTATR00_ILGLERR_Msk     (0x10UL)
 #define R_FACI_LP_FSTATR00_BCERR0_Pos      (3UL)
 #define R_FACI_LP_FSTATR00_BCERR0_Msk      (0x8UL)
 #define R_FACI_LP_FSTATR00_PRGERR01_Pos    (2UL)
 #define R_FACI_LP_FSTATR00_PRGERR01_Msk    (0x4UL)
 #define R_FACI_LP_FSTATR00_PRGERR0_Pos     (1UL)
 #define R_FACI_LP_FSTATR00_PRGERR0_Msk     (0x2UL)
 #define R_FACI_LP_FSTATR00_ERERR0_Pos      (0UL)
 #define R_FACI_LP_FSTATR00_ERERR0_Msk      (0x1UL)
/* ========================================================  FSTATR1  ======================================================== */
 #define R_FACI_LP_FSTATR1_EXRDY_Pos        (7UL)
 #define R_FACI_LP_FSTATR1_EXRDY_Msk        (0x80UL)
 #define R_FACI_LP_FSTATR1_FRDY_Pos         (6UL)
 #define R_FACI_LP_FSTATR1_FRDY_Msk         (0x40UL)
 #define R_FACI_LP_FSTATR1_DRRDY_Pos        (1UL)
 #define R_FACI_LP_FSTATR1_DRRDY_Msk        (0x2UL)
/* =========================================================  FWBL0  ========================================================= */
 #define R_FACI_LP_FWBL0_WDATA_Pos          (0UL)
 #define R_FACI_LP_FWBL0_WDATA_Msk          (0xffffUL)
/* =========================================================  FWBH0  ========================================================= */
 #define R_FACI_LP_FWBH0_WDATA_Pos          (0UL)
 #define R_FACI_LP_FWBH0_WDATA_Msk          (0xffffUL)
/* =======================================================  FSTATR01  ======================================================== */
 #define R_FACI_LP_FSTATR01_BCERR1_Pos      (3UL)
 #define R_FACI_LP_FSTATR01_BCERR1_Msk      (0x8UL)
 #define R_FACI_LP_FSTATR01_PRGERR1_Pos     (1UL)
 #define R_FACI_LP_FSTATR01_PRGERR1_Msk     (0x2UL)
 #define R_FACI_LP_FSTATR01_ERERR1_Pos      (0UL)
 #define R_FACI_LP_FSTATR01_ERERR1_Msk      (0x1UL)
/* =========================================================  FWBL1  ========================================================= */
 #define R_FACI_LP_FWBL1_WDATA47_32_Pos     (0UL)
 #define R_FACI_LP_FWBL1_WDATA47_32_Msk     (0xffffUL)
/* =========================================================  FWBH1  ========================================================= */
 #define R_FACI_LP_FWBH1_WDATA63_48_Pos     (0UL)
 #define R_FACI_LP_FWBH1_WDATA63_48_Msk     (0xffffUL)
/* =========================================================  FRBL1  ========================================================= */
 #define R_FACI_LP_FRBL1_RDATA47_32_Pos     (0UL)
 #define R_FACI_LP_FRBL1_RDATA47_32_Msk     (0xffffUL)
/* =========================================================  FRBH1  ========================================================= */
 #define R_FACI_LP_FRBH1_RDATA63_48_Pos     (0UL)
 #define R_FACI_LP_FRBH1_RDATA63_48_Msk     (0xffffUL)
/* ==========================================================  FPR  ========================================================== */
 #define R_FACI_LP_FPR_FPR_Pos              (0UL)
 #define R_FACI_LP_FPR_FPR_Msk              (0xffUL)
/* =========================================================  FPSR  ========================================================== */
 #define R_FACI_LP_FPSR_PERR_Pos            (0UL)
 #define R_FACI_LP_FPSR_PERR_Msk            (0x1UL)
/* =========================================================  FRBL0  ========================================================= */
 #define R_FACI_LP_FRBL0_RDATA_Pos          (0UL)
 #define R_FACI_LP_FRBL0_RDATA_Msk          (0xffffUL)
/* =========================================================  FRBH0  ========================================================= */
 #define R_FACI_LP_FRBH0_RDATA_Pos          (0UL)
 #define R_FACI_LP_FRBH0_RDATA_Msk          (0xffffUL)
/* =========================================================  FSCMR  ========================================================= */
 #define R_FACI_LP_FSCMR_FSPR_Pos           (14UL)
 #define R_FACI_LP_FSCMR_FSPR_Msk           (0x4000UL)
 #define R_FACI_LP_FSCMR_SASMF_Pos          (8UL)
 #define R_FACI_LP_FSCMR_SASMF_Msk          (0x100UL)
/* ========================================================  FAWSMR  ========================================================= */
 #define R_FACI_LP_FAWSMR_FAWS_Pos          (0UL)
 #define R_FACI_LP_FAWSMR_FAWS_Msk          (0xfffUL)
/* ========================================================  FAWEMR  ========================================================= */
 #define R_FACI_LP_FAWEMR_FAWE_Pos          (0UL)
 #define R_FACI_LP_FAWEMR_FAWE_Msk          (0xfffUL)
/* =========================================================  FISR  ========================================================== */
 #define R_FACI_LP_FISR_SAS_Pos             (6UL)
 #define R_FACI_LP_FISR_SAS_Msk             (0xc0UL)
 #define R_FACI_LP_FISR_PCKA_Pos            (0UL)
 #define R_FACI_LP_FISR_PCKA_Msk            (0x3fUL)
/* =========================================================  FEXCR  ========================================================= */
 #define R_FACI_LP_FEXCR_OPST_Pos           (7UL)
 #define R_FACI_LP_FEXCR_OPST_Msk           (0x80UL)
 #define R_FACI_LP_FEXCR_CMD_Pos            (0UL)
 #define R_FACI_LP_FEXCR_CMD_Msk            (0x7UL)
/* =========================================================  FEAML  ========================================================= */
 #define R_FACI_LP_FEAML_FEAM_Pos           (0UL)
 #define R_FACI_LP_FEAML_FEAM_Msk           (0xffffUL)
/* =========================================================  FEAMH  ========================================================= */
 #define R_FACI_LP_FEAMH_FEAM_Pos           (0UL)
 #define R_FACI_LP_FEAMH_FEAM_Msk           (0xffffUL)
/* ========================================================  FSTATR2  ======================================================== */
 #define R_FACI_LP_FSTATR2_EILGLERR_Pos     (5UL)
 #define R_FACI_LP_FSTATR2_EILGLERR_Msk     (0x20UL)
 #define R_FACI_LP_FSTATR2_ILGLERR_Pos      (4UL)
 #define R_FACI_LP_FSTATR2_ILGLERR_Msk      (0x10UL)
 #define R_FACI_LP_FSTATR2_BCERR_Pos        (3UL)
 #define R_FACI_LP_FSTATR2_BCERR_Msk        (0x8UL)
 #define R_FACI_LP_FSTATR2_PRGERR01_Pos     (2UL)
 #define R_FACI_LP_FSTATR2_PRGERR01_Msk     (0x4UL)
 #define R_FACI_LP_FSTATR2_PRGERR1_Pos      (1UL)
 #define R_FACI_LP_FSTATR2_PRGERR1_Msk      (0x2UL)
 #define R_FACI_LP_FSTATR2_ERERR_Pos        (0UL)
 #define R_FACI_LP_FSTATR2_ERERR_Msk        (0x1UL)
/* ========================================================  FCTLFR  ========================================================= */
 #define R_FACI_LP_FCTLFR_BANKSWP_Pos       (0UL)
 #define R_FACI_LP_FCTLFR_BANKSWP_Msk       (0x7UL)
/* ======================================================  FENTRYR_MF4  ====================================================== */
/* ========================================================  FENTRYR  ======================================================== */
/* ========================================================  FLWAITR  ======================================================== */
/* =======================================================  FLDWAITR  ======================================================== */
 #define R_FACI_LP_FLDWAITR_FLDWAIT1_Pos    (0UL)
 #define R_FACI_LP_FLDWAITR_FLDWAIT1_Msk    (0x1UL)
/* =========================================================  PFBER  ========================================================= */
/* ========================================================  FBKPGCR  ======================================================== */
 #define R_FACI_LP_FBKPGCR_BKPGEN_Pos       (0UL)
 #define R_FACI_LP_FBKPGCR_BKPGEN_Msk       (0x1UL)
 #define R_FACI_LP_FBKPGCR_FEKEY_Pos        (8UL)
 #define R_FACI_LP_FBKPGCR_FEKEY_Msk        (0xff00UL)
/* ========================================================  FBKSWCR  ======================================================== */
 #define R_FACI_LP_FBKSWCR_BKSWUPEN_Pos     (0UL)
 #define R_FACI_LP_FBKSWCR_BKSWUPEN_Msk     (0x1UL)
 #define R_FACI_LP_FBKSWCR_FEKEY_Pos        (8UL)
 #define R_FACI_LP_FBKSWCR_FEKEY_Msk        (0xff00UL)
/* ========================================================  HIOTRM  ========================================================= */
 #define R_FACI_LP_HIOTRM_HIOTRM_Pos        (0UL)
 #define R_FACI_LP_HIOTRM_HIOTRM_Msk        (0x3fUL)
/* ========================================================  FLMODE  ========================================================= */
 #define R_FACI_LP_FLMODE_MODE_Pos          (6UL)
 #define R_FACI_LP_FLMODE_MODE_Msk          (0xc0UL)
/* ========================================================  FLMWRP  ========================================================= */
 #define R_FACI_LP_FLMWRP_FLMWEN_Pos        (0UL)
 #define R_FACI_LP_FLMWRP_FLMWEN_Msk        (0x1UL)
...
/* =======================================================  CTSUTRIMA  ======================================================= */
 #define R_CTSUTRIM_CTSUTRIMA_SUADJTRIM_Pos    (24UL)
 #define R_CTSUTRIM_CTSUTRIMA_SUADJTRIM_Msk    (0xff000000UL)
 #define R_CTSUTRIM_CTSUTRIMA_SUADJD_Pos       (16UL)
 #define R_CTSUTRIM_CTSUTRIMA_SUADJD_Msk       (0xff0000UL)
 #define R_CTSUTRIM_CTSUTRIMA_DACTRIM_Pos      (8UL)
 #define R_CTSUTRIM_CTSUTRIMA_DACTRIM_Msk      (0xff00UL)
 #define R_CTSUTRIM_CTSUTRIMA_RTRIM_Pos        (0UL)
 #define R_CTSUTRIM_CTSUTRIMA_RTRIM_Msk        (0xffUL)
/* =======================================================  CTSUTRIMB  ======================================================= */
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT3_Pos     (24UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT3_Msk     (0xff000000UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT2_Pos     (16UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT2_Msk     (0xff0000UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT1_Pos     (8UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT1_Msk     (0xff00UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT0_Pos     (0UL)
 #define R_CTSUTRIM_CTSUTRIMB_TRESULT0_Msk     (0xffUL)
...
/* ========================================================  TRNGSDR  ======================================================== */
 #define R_TRNG_TRNGSDR_SDATA_Pos       (0UL)
 #define R_TRNG_TRNGSDR_SDATA_Msk       (0xffUL)
/* =======================================================  TRNGSCR0  ======================================================== */
 #define R_TRNG_TRNGSCR0_RDRDY_Pos      (7UL)
 #define R_TRNG_TRNGSCR0_RDRDY_Msk      (0x80UL)
 #define R_TRNG_TRNGSCR0_SGCEN_Pos      (3UL)
 #define R_TRNG_TRNGSCR0_SGCEN_Msk      (0x8UL)
 #define R_TRNG_TRNGSCR0_SGSTART_Pos    (2UL)
 #define R_TRNG_TRNGSCR0_SGSTART_Msk    (0x4UL)
/* =======================================================  TRNGSCR1  ======================================================== */
 #define R_TRNG_TRNGSCR1_INTEN_Pos      (0UL)
 #define R_TRNG_TRNGSCR1_INTEN_Msk      (0x1UL)
...
/* =========================================================  TSCDR  ========================================================= */
/* ========================================================  TSCDRH  ========================================================= */
 #define R_TSN_TSCDRH_TSCDRH_Pos    (0UL)
 #define R_TSN_TSCDRH_TSCDRH_Msk    (0xffUL)
/* ========================================================  TSCDRL  ========================================================= */
 #define R_TSN_TSCDRL_TSCDRL_Pos    (0UL)
 #define R_TSN_TSCDRL_TSCDRL_Msk    (0xffUL)
...
/* ========================================================  AESMOD  ========================================================= */
 #define R_AES_AESMOD_WRRQEN_Pos      (9UL)
 #define R_AES_AESMOD_WRRQEN_Msk      (0x200UL)
 #define R_AES_AESMOD_RDRQEN_Pos      (8UL)
 #define R_AES_AESMOD_RDRQEN_Msk      (0x100UL)
 #define R_AES_AESMOD_MODEN_Pos       (0UL)
 #define R_AES_AESMOD_MODEN_Msk       (0x1UL)
/* ========================================================  AESCMD  ========================================================= */
 #define R_AES_AESCMD_ILOP_Pos        (31UL)
 #define R_AES_AESCMD_ILOP_Msk        (0x80000000UL)
 #define R_AES_AESCMD_KWRDY1_Pos      (30UL)
 #define R_AES_AESCMD_KWRDY1_Msk      (0x40000000UL)
 #define R_AES_AESCMD_KWRDY0_Pos      (29UL)
 #define R_AES_AESCMD_KWRDY0_Msk      (0x20000000UL)
 #define R_AES_AESCMD_IRRDY_Pos       (28UL)
 #define R_AES_AESCMD_IRRDY_Msk       (0x10000000UL)
 #define R_AES_AESCMD_IWRDY_Pos       (27UL)
 #define R_AES_AESCMD_IWRDY_Msk       (0x8000000UL)
 #define R_AES_AESCMD_CWRDY_Pos       (26UL)
 #define R_AES_AESCMD_CWRDY_Msk       (0x4000000UL)
 #define R_AES_AESCMD_DRRDY_Pos       (25UL)
 #define R_AES_AESCMD_DRRDY_Msk       (0x2000000UL)
 #define R_AES_AESCMD_DWRDY_Pos       (24UL)
 #define R_AES_AESCMD_DWRDY_Msk       (0x1000000UL)
 #define R_AES_AESCMD_KEYSEL_Pos      (12UL)
 #define R_AES_AESCMD_KEYSEL_Msk      (0x1000UL)
 #define R_AES_AESCMD_STORESEL_Pos    (8UL)
 #define R_AES_AESCMD_STORESEL_Msk    (0x300UL)
 #define R_AES_AESCMD_CHAIN_Pos       (4UL)
 #define R_AES_AESCMD_CHAIN_Msk       (0x30UL)
 #define R_AES_AESCMD_KEYLN_Pos       (1UL)
 #define R_AES_AESCMD_KEYLN_Msk       (0x2UL)
 #define R_AES_AESCMD_INVCIP_Pos      (0UL)
 #define R_AES_AESCMD_INVCIP_Msk      (0x1UL)
/* =========================================================  AESDW  ========================================================= */
/* ========================================================  AESIVW  ========================================================= */
/* ========================================================  AESKW0  ========================================================= */
/* ========================================================  AESKW1  ========================================================= */
