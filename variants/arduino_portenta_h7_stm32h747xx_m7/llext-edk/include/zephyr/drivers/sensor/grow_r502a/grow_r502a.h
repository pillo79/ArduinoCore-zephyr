...
#define R502A_COMMAND_PACKET 0x1
#define R502A_DATA_PACKET 0x2
#define R502A_ACK_PACKET 0x7
#define R502A_END_DATA_PACKET 0x8

/*Instruction code's definition*/
#define R502A_GENIMAGE 0x01
#define R502A_IMAGE2TZ 0x02
#define R502A_MATCH 0x03
#define R502A_SEARCH 0x04
#define R502A_REGMODEL 0x05
#define R502A_STORE 0x06
#define R502A_LOAD 0x07
#define R502A_UPCHAR 0x08
#define R502A_DOWNCHAR 0x09
#define R502A_IMGUPLOAD 0x0A
#define R502A_DELETE 0x0C
#define R502A_EMPTYLIBRARY 0x0D
#define R502A_SETSYSPARAM 0x0E
#define R502A_READSYSPARAM 0x0F
#define R502A_SETPASSWORD 0x12
#define R502A_VERIFYPASSWORD 0x13
#define R502A_GETRANDOM 0x14
#define R502A_TEMPLATECOUNT 0x1D
#define R502A_READTEMPLATEINDEX 0x1F
#define R502A_LED_CONFIG 0x35
#define R502A_CHECKSENSOR 0x36
#define R502A_SOFTRESET 0x3D
#define R502A_HANDSHAKE 0x40
#define R502A_BADPACKET 0xFE

#define R502A_NOT_MATCH_CC 0x08
#define R502A_NOT_FOUND_CC 0x09
...
#define R502A_PID_IDX 6
#define R502A_PKG_LEN_IDX 7
#define R502A_CC_IDX 9
...
#define R502A_CHAR_BUF_SIZE 384
#define R502A_TEMPLATE_SIZE 768
