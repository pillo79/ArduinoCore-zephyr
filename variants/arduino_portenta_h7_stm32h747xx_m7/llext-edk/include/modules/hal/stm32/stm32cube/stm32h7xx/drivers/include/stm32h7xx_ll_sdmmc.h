...
/**
  ...
  */
#define SDMMC_SDIO_MODE_BYTE                         0x00U
#define SDMMC_SDIO_MODE_BLOCK                        0x01U

/**
  * @brief SDIO_CMD53_OP_CODE
  */
#define SDMMC_SDIO_NO_INC                            0x00U
#define SDMMC_SDIO_AUTO_INC                          0x01U

/**
  * @brief SDIO_CMD53_RAW
  */
#define SDMMC_SDIO_WO                                0x00U
#define SDMMC_SDIO_RAW                               0x01U
...
#define SDMMC_CMD_SET_REL_ADDR                        3U
#define SDMMC_CMD_SET_DSR                             4U
#define SDMMC_CMD_SDMMC_SEN_OP_COND                   5U
#define SDMMC_CMD_HS_SWITCH                           6U
#define SDMMC_CMD_SEL_DESEL_CARD                      7U
#define SDMMC_CMD_HS_SEND_EXT_CSD                     8U
#define SDMMC_CMD_SEND_CSD                            9U
#define SDMMC_CMD_SEND_CID                            10U
#define SDMMC_CMD_VOLTAGE_SWITCH                      11U
#define SDMMC_CMD_STOP_TRANSMISSION                   12U
#define SDMMC_CMD_SEND_STATUS                         13U
#define SDMMC_CMD_HS_BUSTEST_READ                     14U
#define SDMMC_CMD_GO_INACTIVE_STATE                   15U
#define SDMMC_CMD_SET_BLOCKLEN                        16U
/*!< for SDHS and SDXC.                                                                       */
#define SDMMC_CMD_READ_SINGLE_BLOCK                   17U
#define SDMMC_CMD_READ_MULT_BLOCK                     18U
#define SDMMC_CMD_HS_BUSTEST_WRITE                    19U
#define SDMMC_CMD_WRITE_DAT_UNTIL_STOP                20U
#define SDMMC_CMD_SET_BLOCK_COUNT                     23U
#define SDMMC_CMD_WRITE_SINGLE_BLOCK                  24U
#define SDMMC_CMD_WRITE_MULT_BLOCK                    25U
#define SDMMC_CMD_PROG_CID                            26U
#define SDMMC_CMD_PROG_CSD                            27U
#define SDMMC_CMD_SET_WRITE_PROT                      28U
#define SDMMC_CMD_CLR_WRITE_PROT                      29U
#define SDMMC_CMD_SEND_WRITE_PROT                     30U
#define SDMMC_CMD_SD_ERASE_GRP_START                  32U
#define SDMMC_CMD_SD_ERASE_GRP_END                    33U
#define SDMMC_CMD_ERASE_GRP_START                     35U
#define SDMMC_CMD_ERASE_GRP_END                       36U
...
/**
  ...
  */
#define SDMMC_CMD_APP_SD_SET_BUSWIDTH                 6U
#define SDMMC_CMD_SD_APP_STATUS                       13U
#define SDMMC_CMD_SD_APP_SEND_NUM_WRITE_BLOCKS        22U
#define SDMMC_CMD_SD_APP_OP_COND                      41U
#define SDMMC_CMD_SD_APP_SET_CLR_CARD_DETECT          42U
#define SDMMC_CMD_SD_APP_SEND_SCR                     51U
#define SDMMC_CMD_SDMMC_RW_DIRECT                     52U
#define SDMMC_CMD_SDMMC_RW_EXTENDED                   53U

/**
  * @brief Following commands are MMC Specific commands.
  */
#define SDMMC_CMD_MMC_SLEEP_AWAKE                     5U
...
#define SDMMC_CMDTIMEOUT                   ((uint32_t)5000U)
#define SDMMC_MAXERASETIMEOUT              ((uint32_t)63000U)
#define SDMMC_STOPTRANSFERTIMEOUT          ((uint32_t)100000000U)
...
/** @defgroup SDMMC_SDIO_CCCR_Registers
  ...
  */
/*-------------------------------- CCCR0 ----------------------------------*/
#define SDMMC_SDIO_CCCR0                     0x000U
#define SDMMC_SDIO_CCCR0_SD_BYTE0            0x000U
#define SDMMC_SDIO_CCCR0_SD_BYTE1            0x001U
#define SDMMC_SDIO_CCCR0_SD_BYTE2            0x002U
#define SDMMC_SDIO_CCCR0_SD_BYTE3            0x003U

/*-------------------------------- CCCR4 ----------------------------------*/
#define SDMMC_SDIO_CCCR4                     0x004U
#define SDMMC_SDIO_CCCR4_SD_BYTE0            0x004U
#define SDMMC_SDIO_CCCR4_SD_BYTE1            0x005U
#define SDMMC_SDIO_CCCR4_SD_BYTE2            0x006U
#define SDMMC_SDIO_CCCR4_SD_BYTE3            0x007U

/*-------------------------------- CCCR8 ----------------------------------*/
#define SDMMC_SDIO_CCCR8                     0x008U
#define SDMMC_SDIO_CCCR8_SD_BYTE0            0x008U
#define SDMMC_SDIO_CCCR8_SD_BYTE1            0x009U
#define SDMMC_SDIO_CCCR8_SD_BYTE2            0x00AU
#define SDMMC_SDIO_CCCR8_SD_BYTE3            0x00BU

/*-------------------------------- CCCR12 ---------------------------------*/
#define SDMMC_SDIO_CCCR12                    0x00CU
#define SDMMC_SDIO_CCCR12_SD_BYTE0           0x00CU
#define SDMMC_SDIO_CCCR12_SD_BYTE1           0x00DU
#define SDMMC_SDIO_CCCR12_SD_BYTE2           0x00EU
#define SDMMC_SDIO_CCCR12_SD_BYTE3           0x00FU

/*-------------------------------- CCCR16 ---------------------------------*/
#define SDMMC_SDIO_CCCR16                    0x010U
#define SDMMC_SDIO_CCCR16_SD_BYTE0           0x010U
#define SDMMC_SDIO_CCCR16_SD_BYTE1           0x011U
#define SDMMC_SDIO_CCCR16_SD_BYTE2           0x012U
#define SDMMC_SDIO_CCCR16_SD_BYTE3           0x013U

/*-------------------------------- CCCR20 ---------------------------------*/
#define SDMMC_SDIO_CCCR20                    0x014U
#define SDMMC_SDIO_CCCR20_SD_BYTE0           0x014U
#define SDMMC_SDIO_CCCR20_SD_BYTE1           0x015U
#define SDMMC_SDIO_CCCR20_SD_BYTE2           0x016U
#define SDMMC_SDIO_CCCR20_SD_BYTE3           0x017U

/*-------------------------------- F1BR0 ----------------------------------*/
#define SDMMC_SDIO_F1BR0                     0x100U
#define SDMMC_SDIO_F1BR0_SD_BYTE0            0x100U
#define SDMMC_SDIO_F1BR0_SD_BYTE1            0x101U
#define SDMMC_SDIO_F1BR0_SD_BYTE2            0x102U
#define SDMMC_SDIO_F1BR0_SD_BYTE3            0x103U

/*-------------------------------- F1BR8 ----------------------------------*/
#define SDMMC_SDIO_F1BR8                     0x108U
#define SDMMC_SDIO_F1BR8_SD_BYTE0            0x108U
#define SDMMC_SDIO_F1BR8_SD_BYTE1            0x109U
#define SDMMC_SDIO_F1BR8_SD_BYTE2            0x10AU
#define SDMMC_SDIO_F1BR8_SD_BYTE3            0x10BU

/*-------------------------------- F1BR12 ---------------------------------*/
#define SDMMC_SDIO_F1BR12                    0x10CU
#define SDMMC_SDIO_F1BR12_SD_BYTE0           0x10CU
#define SDMMC_SDIO_F1BR12_SD_BYTE1           0x10DU
#define SDMMC_SDIO_F1BR12_SD_BYTE2           0x10EU
#define SDMMC_SDIO_F1BR12_SD_BYTE3           0x10FU

/*-------------------------------- F1BR16 ---------------------------------*/
#define SDMMC_SDIO_F1BR16                    0x110U
#define SDMMC_SDIO_F1BR16_SD_BYTE0           0x110U
#define SDMMC_SDIO_F1BR16_SD_BYTE1           0x111U
#define SDMMC_SDIO_F1BR16_SD_BYTE2           0x112U
#define SDMMC_SDIO_F1BR16_SD_BYTE3           0x113U
/**
  * @}
  */
